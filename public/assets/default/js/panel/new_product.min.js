...
(function ($) {
  ...
  function handleSpecificationSelect2(elClassName) {
    ...
    if (el && el.length) {
      el.select2({
        placeholder: $(this).data('placeholder') //minimumInputLength: 3,
        //allowClear: true,
  ...
  $('body').on('change', '.js-ajax-file_type', function (e) {
    ...
    var $form = $(this).closest('.file-form'); //const source = formGroup.find('.js-file-storage').val();
...
/***/ 17:
/*!*************************************************!*\
  !*** multi ./resources/js/panel/new_product.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/jack/projects/webinar/resources/js/panel/new_product.js */"./resources/js/panel/new_product.js");
