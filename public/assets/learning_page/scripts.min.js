  ...
  $('body').on('click', '.js-save-history-message', function () {
    ...
    $.post(action, data, function (result) {
      ...
      if (result && result.code === 200) {
        ...
        Swal.fire({
          icon: 'success',
          html: '<h3 class="font-20 text-center text-black">' + sendAssignmentSuccessLang + '</h3>',
          showConfirmButton: false
        });
  ...
  $('body').on('click', '.js-save-history-rate', function () {
    ...
    $.post(action, data, function (result) {
      ...
      if (result && result.code === 200) {
        ...
        Swal.fire({
          icon: 'success',
          html: '<h3 class="font-20 text-center text-black">' + saveAssignmentRateSuccessLang + '</h3>',
          showConfirmButton: false
        });
        $this.removeClass('loadingbar primary').prop('disabled', false);
        // setTimeout(function () {
