    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            // }),
                ...
                $studentId = apiAuth()?->id;
                $assignments = $webinar->assignments ?? collect();

                $totalAssignments = $assignments->count();
                $submittedCount = $assignments->whereNotNull('assignment_history')
                    ->where('assignment_history.student_id', $studentId)
                    ->count();
                ...
                return [
                    ...
                    'remaining_assignments' => max(0, $totalAssignments - $submittedCount),
                ];
            }),
