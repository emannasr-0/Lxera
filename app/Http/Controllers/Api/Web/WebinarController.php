...
class WebinarController extends Controller
{
    ...
    public function index()
    {
        ...
        $categories = Category::whereHas( 'webinars', function($query){
            $query->where('unattached', 1);
        })
        ...
        return apiResponse2(1, 'retrieved', trans('api.public.retrieved'), ['categories' => CourseCategoryResource::collection($categories)]);
