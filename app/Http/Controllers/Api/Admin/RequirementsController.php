...
public function rejectionReasons()
{
    ...
    $rejections = [
        'issue_id_passport',
        'issue_bachelor_certificate',
        'issue_highschool_certificate',
        'issue_academic_record',
        'issue_cv',
        'issue_study_purpose',
        'issue_experience',
        'issue_recommendation',
        'issue_professional_background',
    ];

    foreach ($rejections as $rejection) {
        $rejectionReasons[] = [
            'label_en' => trans('admin/main.' . $rejection, [], 'en'),
            'label_ar' => trans('admin/main.' . $rejection, [], 'ar'),
        ];
    }
