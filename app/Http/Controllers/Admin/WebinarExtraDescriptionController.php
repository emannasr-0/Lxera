...
class WebinarExtraDescriptionController extends Controller
{
   ...
   public function updateWebinarExtraDescription($url_name, Request $request, $id)
{
    $this->authorize('admin_webinars_edit');
    ...
    if ($webinarExtraDescription) {
        $translation = WebinarExtraDescriptionTranslation::where('webinar_extra_description_id', $webinarExtraDescription->id)
        ...
        if ($translation) {
            ...
            // Optional: return error if translation doesn't exist
            return response()->json([
                'code' => 404,
        ...
        return response()->json([
            'code' => 404,
            'message' => 'Webinar extra description not found.',
        ], 404);
    }
    ...
    public function destroyWebinarExtraDescription($url_name,Request $request, $id)
    {
        $this->authorize('admin_webinars_edit');
    ...
    {
        $webinar = Webinar::with('webinarExtraDescription')->find($id);
        ...
        return response()->json([
            'code' => 200,
            'webinarExtraDescription' => $webinar->webinarExtraDescription,
        ]);
    }
}
