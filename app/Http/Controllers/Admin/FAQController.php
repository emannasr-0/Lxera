...
class FAQController extends Controller
{
    ...
    public function descriptionFaq($url_name,Request $request, $id)
    {
        $this->authorize('admin_webinars_edit');
    ...
    public function updateFaq($url_name, Request $request, $id)
    {
        $this->authorize('admin_webinars_edit');
        ...
        if ($faq) {
            // Update Faq model if needed, or let Eloquent auto-update timestamps
            $faq->touch(); // This updates only updated_at timestamp
    ...
    public function destroyFaq($url_name, Request $request, $id)
    {
        $this->authorize('admin_webinars_edit');
    ...
    {
        $webinar = Webinar::with('faqs')->find($id);
