...
class InstallmentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'deadline_type' => 'required|in:days,date',
        ]);
            ...
            foreach ($data['steps'] as $stepId => $stepData) {
                if (!empty($stepData) and $stepId != "record") {
                    ...
                    InstallmentStepTranslation::query()->updateOrCreate([
                        ...
                        SelectedInstallmentStep::where('installment_step_id', $step->id)->update([
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($installment)) {
            SelectedInstallment::where('installment_id', $installment->id)->update(['deadline_type' =>$installment->deadline_type]);
            $this->storeExtraData($installment, $data);
