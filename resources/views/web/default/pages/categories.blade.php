...
@section('content')
            ...
            <div class=" js-font-resize row h-100 align-items-center justify-content-center text-center">
                <div class=" js-font-resize col-12 col-md-9 col-lg-7">
                    <div class=" js-font-resize top-search-categories-form">
                        <h1 class=" js-font-resize text-white font-30 mb-15">{{ !empty($category) ? $category->title : $pageTitle }}</h1>
                        <span class=" js-font-resize course-count-badge py-5 px-10 text-white rounded">{{ $webinarsCount }} {{ trans('product.courses') }}</span>
    ...
    <div class=" js-font-resize container mt-30">
        ...
        @if(!empty($featureWebinars) and !$featureWebinars->isEmpty())
            <section class=" js-font-resize mb-25 mb-lg-0">
                <h2 class=" js-font-resize font-24 text-dark-blue">{{ trans('home.featured_webinars') }}</h2>
                <span class=" js-font-resize font-14 text-gray font-weight-400">{{ trans('site.newest_courses_subtitle') }}</span>

                <div class=" js-font-resize position-relative mt-20">
                    <div class=" js-font-resize swiper-container">
                    ...
                    <div class=" js-font-resize d-flex justify-content-center">
                        <div class=" js-font-resize swiper-pagination"></div>
                    </div>
                </div>
                ...
                <div class=" js-font-resize row mt-20">
                    ...
                    <div class=" js-font-resize col-12 col-lg-4">
                        <!--<div class=" js-font-resize mt-20 p-20 rounded-sm shadow-lg border border-gray300 filters-container">-->
                            ...
                            <!--<div class=" js-font-resize mt-25 pt-25 border-top border-gray300">-->
                            <!--    <h3 class=" js-font-resize category-filter-title font-20 font-weight-bold text-dark-blue">{{ trans('site.more_options') }}1</h3>-->
