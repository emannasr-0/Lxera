            ...
            <div class="row">
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-light font-weight-bold mt-5">{{ $availablePoints }}</strong>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-light font-weight-bold mt-5">{{ $totalPoints }}</strong>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-light font-weight-bold mt-5">{{ $spentPoints }}</strong>
            ...
            <div class="rounded-sm bg-white shadow-lg px-15 px-lg-25 py-15 py-lg-35">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-7 mt-20 mt-lg-0 text-center">
                        <h3 class="font-16 font-weight-bold text-light">{{ trans('update.exchange_or_get_a_course') }}</h3>
       ...
       {{-- <div class="col-12 col-lg-6 mt-20 mt-lg-0">
            <div class="d-flex align-items-center justify-content-between rounded-sm bg-white p-15 shadow-lg">
                <div class="d-flex align-items-center ">
                    ...
                    <div class="ml-15">
                        <h3 class="font-16 font-weight-bold text-light">{{ trans('update.want_more_points') }}</h3>
                ...
                <div class="rounded-sm bg-white p-15 shadow-lg mt-20">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-5">
                            <h3 class="text-light font-16 font-weight-bold">{{ trans('update.leaderboard') }}</h3>
