                                        ...
                                        <td class="text-left align-middle">
                                            <div class="user-inline-avatar d-flex align-items-center">
                                                ...
                                                <a href="{{ $post->topic->getPostsUrl() }}" target="_blank" class="">
                                                    <div class=" ml-5">
                                                        <span class="d-block font-14 font-weight-500 text-light">{{ $post->topic->title }}</span>
                                                        <span class="font-12 text-gray mt-5">{{ trans('public.by') }} {{ $post->topic->creator->full_name }}</span>
                                                    </div>
                                                </a>
                                            </div>
                                        </td>
                                        <td class="text-center align-middle text-light">{{ $post->topic->forum->title }}</td>
                                        <td class="text-center align-middle text-light">{{ $post->replies_count }}</td>
                                        <td class="text-center align-middle text-light">{{ dateTimeFormat($post->created_at, 'j M Y H:i') }}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
