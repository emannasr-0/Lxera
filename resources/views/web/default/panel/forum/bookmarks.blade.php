                            ...
                            <table class="table text-center custom-table">
                                ...
                                @foreach($topics as $topic)
                                    <tr>
                                        <td class="text-left align-middle">
                                            <div class="user-inline-avatar d-flex align-items-center">
                                                ...
                                                <a href="{{ $topic->getPostsUrl() }}" target="_blank" class="">
                                                    <div class=" ml-5">
                                                        <span class="d-block font-16 font-weight-500 text-light">{{ $topic->title }}</span>
                                        ...
                                        <td class="text-center align-middle text-light">{{ dateTimeFormat($topic->created_at, 'j M Y H:i') }}</td>
