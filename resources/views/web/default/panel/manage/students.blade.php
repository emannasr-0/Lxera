            ...
            <div class="row">
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-light font-weight-bold mt-5">{{ $inActiveCount }}</strong>
                            ...
                            <table class="table custom-table text-center ">
                                ...
                                @foreach($users as $user)
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <span class="text-light font-weight-500">{{ count($user->getPurchasedCoursesIds()) }}</span>
                                        </td>
                                        <td class="align-middle">
                                            <span class="text-light font-weight-500">{{ count($user->getActiveQuizzesResults()) }}</span>
                                        </td>
                                        <td class="align-middle">
                                            <span class="text-light font-weight-500">{{ count($user->certificates) }}</span>
                                        </td>
