...
@section('content')
    ...
    <section>
        <h2 class=" js-font-resize section-title">{{ trans('public.instructors') }}</h2>
            ...
            <div class=" js-font-resize row">
                <div class=" js-font-resize col-4 d-flex align-items-center justify-content-center">
                    <div class=" js-font-resize d-flex flex-column align-items-center text-center">
                        ...
                        <span class=" js-font-resize font-16 text-gray font-weight-500">{{ trans('public.instructors') }}</span>
                    </div>
                </div>
                ...
                <div class=" js-font-resize col-4 d-flex align-items-center justify-content-center">
                    <div class=" js-font-resize d-flex flex-column align-items-center text-center">
                        ...
                        <strong class=" js-font-resize font-30 text-light font-weight-bold mt-5">{{ $verifiedCount }}</strong>
                        <span class=" js-font-resize font-16 text-gray font-weight-500">{{ trans('public.verified') }}</span>
                    </div>
                </div>
    ...
    <section class=" js-font-resize mt-35">
        <h2 class=" js-font-resize section-title">{{ trans('panel.filter_instructors') }}</h2>

        @include('web.default.panel.manage.filters')
    </section>

    <section class=" js-font-resize mt-35">
        <h2 class=" js-font-resize section-title">{{ trans('panel.instructors_list') }}</h2>
                        ...
                        <div class=" js-font-resize table-responsive">
                            <table class=" js-font-resize table custom-table text-center ">
                                ...
                                <tr>
                                    ...
                                    <th class=" js-font-resize text-center text-gray">{{ trans('panel.sales') }}</th>
                                    <th class=" js-font-resize text-center text-gray">{{ trans('panel.sales_amount') }}</th>
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        <td class=" js-font-resize text-left">
                                            <div class=" js-font-resize user-inline-avatar d-flex align-items-center">
                                                ...
                                                <div class=" js-font-resize  ml-5">
                                                    ...
                                                    <span class=" js-font-resize mt-5 d-block font-12 {{ ($user->verified ? ' text-primary ' : ' text-warning ') }}">{{ trans('public.'.($user->verified ? 'verified' : 'not_verified')) }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class=" js-font-resize text-left">
                                        ...
                                        <td class=" js-font-resize align-middle">
                                            <span class=" js-font-resize text-light font-weight-500">{{ $user->webinars->count() }}</span>
                                        </td>
                                        <td class=" js-font-resize align-middle">
                                            <span class=" js-font-resize text-light font-weight-500">{{ $user->salesCount() }}</span>
                                        </td>
                                        <td class=" js-font-resize align-middle">
                                            <span class=" js-font-resize text-light font-weight-500">{{ handlePrice($user->sales()) }}</span>
                                        </td>
                                        ...
                                        <td class=" js-font-resize text-right align-middle">
                                            <div class=" js-font-resize btn-group dropdown table-actions">
                                                ...
                                                <div class=" js-font-resize dropdown-menu">
                                                    ...
                                                    <a href="/panel/manage/instructors/{{ $user->id }}/edit" class=" js-font-resize btn-transparent webinar-actions d-block mt-10">{{ trans('public.edit') }}</a>
                                                    <a href="/panel/manage/instructors/{{ $user->id }}/delete" class=" js-font-resize webinar-actions d-block mt-10 delete-action">{{ trans('public.delete') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
