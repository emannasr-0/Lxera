...
{{-- Relatives --}}
<section>
    <h2 class=" js-font-resize section-title after-line">{{trans('public.emergency_contact_information')}}</h2>
    <section class=" js-font-resize main-container bg-secondary-acadima border-2 border-secondary-subtle rounded-sm p-3 mt-2 mb-25 row mx-0">
        <div class=" js-font-resize form-group col-12 col-sm-6">
            ...
            <input type="text" id="referral_person" name="referral_person"
                ...
                class=" js-font-resize form-control  @error('referral_person') is-invalid @enderror">
        ...
        <div class=" js-font-resize form-group col-12 col-sm-6">
            ...
            <input type="text" id="relation" name="relation"
                ...
                required class=" js-font-resize form-control  @error('relation') is-invalid @enderror">
        ...
        <div class=" js-font-resize form-group col-12 col-sm-6">
            <label for="referral_email">{{ trans('application_form.email') }}<span class=" js-font-resize text-danger">*</span></label>
            <input type="email" id="referral_email" name="referral_email"
                ...
                class=" js-font-resize form-control  @error('referral_email') is-invalid @enderror">
        ...
        <div class=" js-font-resize form-group col-12 col-sm-6">
            <label>{{ trans('application_form.phone') }}<span class=" js-font-resize text-danger">*</span></label>
            <input type="tel" id="referral_phone" placeholder="{{trans('public.enter_phone')}}" name="referral_phone"
                ...
                class=" js-font-resize form-control  @error('referral_phone') is-invalid @enderror">
