            ...
            <div class="row">
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ $quizResultsCount }}</strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ $quizAvgGrad }}</strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ $successRate }}%</strong>
                                    ...
                                    <tr>
                                        <td class="text-left align-middle">
                                            <div class="user-inline-avatar d-flex align-items-center">
                                                ...
                                                <div class=" ml-5">
                                                    <span class="d-block text-black">{{ $result->user->full_name }}</span>
                                                    <span class="mt-5 font-12 text-gray d-block">{{ $result->user->email }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-middle align-middle text-black">
                                            <span class="d-block">{{ $result->quiz->title }}</span>
                                            <span class="font-12 text-gray d-block">{{ $result->quiz->webinar->title }}</span>
                                        </td>
                                        <td class="align-middle text-black">{{ $result->getQuestions()->sum('grade') }}</td>
                                        <td class="align-middle text-black">{{ $result->user_grade }}</td>
                                        ...
                                        <td class="align-middle text-black">{{ dateTimeFormat($result->created_at, 'j M Y H:i') }}</td>
