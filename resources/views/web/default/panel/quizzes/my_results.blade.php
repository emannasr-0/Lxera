            ...
            <div class="row">
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ $quizzesResultsCount }}</strong>
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ $passedCount }}</strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ $failedCount }}</strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ $waitingCount }}</strong>
            ...
            <form action="/panel/quizzes/my-results" method="get" class="row">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label class="input-label text-dark">{{ trans('public.from') }}</label>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label class="input-label text-dark">{{ trans('public.to') }}</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="dateInputGroupPrepend">
                                            <i data-feather="calendar" width="18" height="18" class="text-light"></i>
                ...
                <div class="col-12 col-lg-6">
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="form-group">
                                <label class="input-label text-dark">{{ trans('quiz.quiz_or_webinar') }}</label>
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="row">
                                <div class="col-12 col-lg-8">
                                    <div class="form-group">
                                        <label class="input-label text-dark">{{ trans('public.instructor') }}</label>
                                        <input type="text" name="instructor" class="form-control" value="{{ request()->get('instructor','') }}"/>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        <label class="input-label text-dark">{{ trans('public.status') }}</label>
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">{{ trans('quiz.quiz') }}</th>
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <div class="user-inline-avatar d-flex align-items-center">
                                                ...
                                                <div class=" ml-5">
                                                    <span class="d-block text-dark">{{ $result->quiz->creator->full_name }}</span>
                                                    <span class="mt-5 font-12 text-gray d-block">{{ $result->quiz->creator->email }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-middle">
                                            <span class="d-block text-dark">{{ $result->quiz->title }}</span>
                                            <span class="font-12 text-gray d-block">{{ $result->quiz->webinar->title }}</span>
                                        </td>
                                        <td class="align-middle text-dark">{{ $result->quiz->quizQuestions->sum('grade') }}</td>

                                        <td class="align-middle text-dark">{{ $result->user_grade }}</td>
                                        ...
                                        <td class="align-middle text-dark">{{ dateTimeFormat($result->created_at,'j M Y H:i')}}</td>
