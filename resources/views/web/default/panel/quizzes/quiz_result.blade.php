        ...
        <section class="mt-30 quiz-form">
            <form action="{{ !empty($newQuizStart) ? '/panel/quizzes/'. $newQuizStart->quiz->id .'/update-result' : '' }} " method="post">
                                    ...
                                    <div class="question-multi-answers mt-35">
                                        @foreach($question->quizzesQuestionsAnswers as $key => $answer)
                                            <div class="answer-item">
                                                @if($answer->correct)
                                                    <span class="badge badge-primary text-dark-blue correct">{{ trans('quiz.correct') }}</span>
                                                @endif
                                                ...
                                                @if(!$answer->image)
                                                    <label for="asw-{{ $answer->id }}" class="answer-label font-16 d-flex text-light align-items-center justify-content-center ">
                                                ...
                                                @else
                                                    <label for="asw-{{ $answer->id }}" class="answer-label font-16 d-flex align-items-center text-light justify-content-center ">
                ...
                <div class="row d-flex align-items-center m-10">
                    <button type="button" disabled class="previous btn btn-sm btn-primary mr-md-10 mr-5">{{ trans('quiz.previous_question') }}</button>
