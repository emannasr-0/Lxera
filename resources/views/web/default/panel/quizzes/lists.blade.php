            ...
            <div class="row">
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ $quizzesCount }}</strong>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ $questionsCount }}</strong>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ $userCount }}</strong>
                                ...
                                @foreach($quizzes as $quiz)
                                    <tr>
                                        <td class="text-left">
                                            ...
                                            <span class="font-12 text-dark d-block">
                                        ...
                                        <td class="text-center align-middle text-dark">
                                            ...
                                            @if(($quiz->display_limited_questions and !empty($quiz->display_number_of_questions)))
                                                <span class="font-12 text-dark">({{ trans('public.active') }}: {{ $quiz->display_number_of_questions }})</span>
                                            @endif
                                        </td>
                                        <td class="text-center align-middle text-dark">{{ $quiz->time }}</td>
                                        <td class="text-center align-middle text-dark">{{ $quiz->quizQuestions->sum('grade') }}</td>
                                        <td class="text-center align-middle text-dark">{{ $quiz->pass_mark }}</td>
                                        <td class="text-center align-middle text-dark">
                                            <span class="d-block">{{ $quiz->quizResults->pluck('user_id')->count() }}</span>

                                            @if(!empty($quiz->userSuccessRate) and $quiz->userSuccessRate > 0)
                                                <span class="font-12 text-primary d-block text-dark">{{ $quiz->userSuccessRate }}% {{ trans('quiz.passed')  }}</span>
                                            @endif
                                        </td>

                                        <td class="text-center align-middle text-dark">{{ trans('public.'.$quiz->status) }}</td>

                                        <td class="text-center align-middle text-dark">{{ dateTimeFormat($quiz->created_at, 'j M Y H:i') }}</td>
                                        <td class="text-center align-middle text-dark">
