...
@section('content')
    ...
    @if (!empty($overdueInstallments) and count($overdueInstallments))
        <div class="d-flex align-items-center mb-20 mt-20 p-15 danger-transparent-alert">
             ...
             <div class="row">
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-light font-weight-bold mt-5">{{ $totalParts }}</strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-light font-weight-bold mt-5">{{ $remainedParts }}</strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-light font-weight-bold mt-5">{{ handlePrice($remainedAmount) }}</strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-light font-weight-bold mt-5">{{ handlePrice($overdueAmount) }}</strong>
                            ...
                            <tbody>
                                ...
                                @if (!empty($installment->upfront))
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{ handlePrice($installment->getUpfront($itemPrice)) }}
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @else
                                                <span class="text-light">{{ trans('update.unpaid') }}</span>
                                            @endif
                                        </td>
                                        <td class="text-right">
                                ...
                                @foreach ($installment->steps as $step)
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <div class="d-block font-16 font-weight-500 text-light">
                                            ...
                                            {{--
                                             <span class="d-block font-12 text-gray">{{ $step->deadline }} أيام بعد بداية
                                                الدورة</span>
                                                --}}
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @else
                                                <span
                                                    class="{{ $isOverdue ? 'text-danger' : 'text-light' }}">{{ trans('update.unpaid') }}
