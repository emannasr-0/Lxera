                                ...
                                @foreach($comments as $comment)
                                    <tr>
                                        ...
                                        <td class=" text-left align-middle" width="35%">
                                            <a href="{{ $comment->product->getUrl() }}" target="_blank" class="text-light font-weight-500">{{ $comment->product->title }}</a>
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            @else
                                                <span class="text-light font-weight-500">{{ trans('panel.replied') }}</span>
                                            @endif
                                        </td>
