    ...
    <div class=" js-font-resize row">
        <div class=" js-font-resize col-12">
            <div class=" js-font-resize form-group mt-15">
                <textarea name="message_for_reviewer" rows="10" class=" js-font-resize form-control">{{ (!empty($upcomingCourse) and $upcomingCourse->message_for_reviewer) ? $upcomingCourse->message_for_reviewer : old('message_for_reviewer') }}</textarea>
            </div>
        </div>
    </div>
