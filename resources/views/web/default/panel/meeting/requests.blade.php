...
@section('content')
            ...
            <div class="row">
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 font-weight-bold text-dark mt-5">{{ $pendingReserveCount }}</strong>
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 font-weight-bold text-dark mt-5">{{ $totalReserveCount }}</strong>
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 font-weight-bold text-dark mt-5">{{ handlePrice($sumReservePaid) }}</strong>
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 font-weight-bold text-dark mt-5">{{ convertMinutesToHourAndMinute($activeHoursCount / 60) }}</strong>
    ...
    <div class="d-none" id="liveMeetingLinkModal">
        <h3 class="section-title after-line font-20 text-light mb-25">{{ trans('panel.add_live_meeting_link') }}</h3>
