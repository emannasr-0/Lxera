...
@section('content')
            ...
            <div class=" js-font-resize row">
                <div class=" js-font-resize col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class=" js-font-resize d-flex flex-column align-items-center text-center">
                        ...
                        <strong class=" js-font-resize font-30 font-weight-bold text-dark mt-5">{{ $pendingReserveCount }}</strong>
                        <span class=" js-font-resize font-16 text-gray font-weight-500">{{ trans('panel.pending_appointments') }}</span>
                    </div>
                </div>
                ...
                <div class=" js-font-resize col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class=" js-font-resize d-flex flex-column align-items-center text-center">
                        ...
                        <strong class=" js-font-resize font-30 font-weight-bold text-dark mt-5">{{ $totalReserveCount }}</strong>
                        <span class=" js-font-resize font-16 text-gray font-weight-500">{{ trans('panel.total_meetings') }}</span>
                    </div>
                </div>
                ...
                <div class=" js-font-resize col-6 col-md-3 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class=" js-font-resize d-flex flex-column align-items-center text-center">
                        ...
                        <strong class=" js-font-resize font-30 font-weight-bold text-dark mt-5">{{ handlePrice($sumReservePaid) }}</strong>
                ...
                <div class=" js-font-resize col-6 col-md-3 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class=" js-font-resize d-flex flex-column align-items-center text-center">
                        ...
                        <strong class=" js-font-resize font-30 font-weight-bold text-dark mt-5">{{ convertMinutesToHourAndMinute($activeHoursCount / 60) }}</strong>
    ...
    <section class=" js-font-resize mt-25">
        ...
        <div class=" js-font-resize panel-section-card py-20 px-25 mt-20">
            <form action="/panel/meetings/requests" method="get" class=" js-font-resize row">
                            ...
                            <div class=" js-font-resize row">
                                <div class=" js-font-resize col-12 col-lg-8">
                                    <div class=" js-font-resize form-group">
                                        ...
                                        <select name="student_id" class=" js-font-resize form-control select2 ">
    ...
    <section class=" js-font-resize mt-35 pb-50 mb-50">
        <form action="/panel/meetings/requests?{{ http_build_query(request()->all()) }}" method="get" class=" js-font-resize d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class=" js-font-resize section-title">{{ trans('panel.meeting_requests_list') }}</h2>
            ...
            <div class=" js-font-resize d-flex align-items-center flex-row-reverse flex-md-row justify-content-start justify-content-md-center mt-20 mt-md-0">
                ...
                <div class=" js-font-resize custom-control custom-switch">
                    <input type="checkbox" name="open_meetings" {{ (request()->get('open_meetings', '') == 'on') ? 'checked' : '' }} class=" js-font-resize js-panel-list-switch-filter custom-control-input" id="openMeetingResult">
                            ...
                            <table class=" js-font-resize table text-center custom-table">
                                ...
                                @foreach($reserveMeetings as $ReserveMeeting)
                                    <tr>
                                        <td class=" js-font-resize text-left">
                                            <div class=" js-font-resize user-inline-avatar d-flex align-items-center">
                                                <div class=" js-font-resize avatar bg-gray200">
                                                    <img src="{{ $ReserveMeeting->user->getAvatar() }}" class=" js-font-resize img-cover" alt="">
                                                </div>
                                                <div class=" js-font-resize  ml-5">
                                                    <span class=" js-font-resize d-block font-weight-500">{{ $ReserveMeeting->user->full_name }}</span>
                                                    <span class=" js-font-resize mt-5 font-12 text-gray d-block">{{ $ReserveMeeting->user->email }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class=" js-font-resize font-weight-500 align-middle">{{ handlePrice($ReserveMeeting->paid_amount) }}</td>
                                        ...
                                        <td class=" js-font-resize align-middle">
                                            @switch($ReserveMeeting->status)
                                                @case(\App\Models\ReserveMeeting::$pending)
                                                    <span class=" js-font-resize font-weight-500">{{ trans('public.pending') }}</span>
                                                    @break
                                                ...
                                                @case(\App\Models\ReserveMeeting::$finished)
                                                    <span class=" js-font-resize font-weight-500">{{ trans('public.finished') }}</span>
                                                    @break
                                                @case(\App\Models\ReserveMeeting::$canceled)
                                                    <span class=" js-font-resize font-weight-500">{{ trans('public.canceled') }}</span>
                                                    @break
                                            @endswitch
                                        </td>
                                                    ...
                                                    <div class=" js-font-resize dropdown-menu menu-lg">
                                                        ...
                                                        @if(getFeaturesSettings('agora_for_meeting') and $ReserveMeeting->meeting_type != 'in_person')
                                                            @if(empty($ReserveMeeting->session))
                                                                <button type="button" data-item-id="{{ $ReserveMeeting->id }}" data-date="{{ dateTimeFormat($ReserveMeeting->start_at, 'j M Y H:i') }}"
                                                                        class=" js-font-resize js-add-meeting-session btn-transparent webinar-actions d-block mt-10 text-primary">{{ trans('update.create_a_session') }}</button>
                                                        ...
                                                        @if($ReserveMeeting->meeting_type != 'in_person')
                                                            <button type="button" data-item-id="{{ $ReserveMeeting->id }}"
                                                                    class=" js-font-resize add-meeting-url btn-transparent webinar-actions d-block mt-10">{{ trans('panel.create_link') }}</button>
                                                        @endif

                                                        <a href="{{ $ReserveMeeting->addToCalendarLink() }}" target="_blank" class=" js-font-resize webinar-actions d-block mt-10 font-weight-normal">{{ trans('public.add_to_calendar') }}</a>

                                                        <button type="button"
                                                                data-user-id="{{ $ReserveMeeting->user_id }}"
                                                                data-item-id="{{ $ReserveMeeting->id }}"
                                                                data-user-type="student"
                                                                class=" js-font-resize contact-info btn-transparent webinar-actions d-block mt-10">{{ trans('panel.contact_student') }}</button>
    ...
    <div class=" js-font-resize d-none" id="liveMeetingLinkModal">
        <h3 class=" js-font-resize section-title after-line font-20 text-light mb-25">{{ trans('panel.add_live_meeting_link') }}</h3>
            ...
            <div class=" js-font-resize row">
                <div class=" js-font-resize col-12 col-md-8">
                    <div class=" js-font-resize form-group">
                        ...
                        <input type="text" name="link" class=" js-font-resize form-control"/>
                ...
                <div class=" js-font-resize col-12 col-md-4">
                    <div class=" js-font-resize form-group">
                        ...
                        <input type="text" name="password" class=" js-font-resize form-control"/>
                        <div class=" js-font-resize invalid-feedback"></div>
                    </div>
                </div>
            </div>
            <p class=" js-font-resize font-weight-500 font-12 text-gray">{{ trans('panel.add_live_meeting_link_hint') }}</p>

            <div class=" js-font-resize mt-30 d-flex align-items-center justify-content-end">
                <button type="button" class=" js-font-resize js-save-meeting-link btn btn-sm btn-primary">{{ trans('public.save') }}</button>
