                            ...
                            <table class="table text-center custom-table">
                                ...
                                @foreach(\App\Models\MeetingTime::$days as $day)
                                    <tr id="{{ $day }}TimeSheet" data-day="{{ $day }}">
                                        <td class="text-left">
                                            <span class="font-weight-500 text-dark d-block">{{ trans('panel.'.$day) }}</span>
                                            <span class="font-12 text-dark">{{ isset($meetingTimes[$day]) ? $meetingTimes[$day]["hours_available"] : 0 }} {{ trans('home.hours') .' '. trans('public.available') }}</span>
                                        </td>
                                        <td class="time-sheet-items text-left align-middle text-dark">
                                            @if(isset($meetingTimes[$day]))
                                                @foreach($meetingTimes[$day]["times"] as $time)
                                                    <div class="position-relative selected-time px-15 py-5 mb-10 bg-acadima-pink rounded d-inline-block mr-10">
                                                        <span class="inner-time text-light font-12">
                                                            {{ $time->time }}

                                                            <span class="mx-5">-</span>

                                                            <span class="font-12 text-light">{{ trans('update.'.($time->meeting_type == 'all' ? 'both' : $time->meeting_type)) }}</span>
                                                        </span>
        ...
        <div class="mt-30">
            ...
            <div class="row align-items-center mt-20">
                ...
                <div class="col-12 col-md-3">
                    <label class="font-weight-500 font-14 text-light d-block">{{ trans('panel.amount') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text text-light font-16">
                                {{ $currency }}
                            </span>
                        </div>
                ...
                <div class="col-12 col-md-3">
                    <label class="font-weight-500 font-14 text-light d-block">{{ trans('panel.discount') }} (%)</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text text-light font-16">%</span>
                        </div>
        ...
        <div class="mt-30">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 {{ ((!empty($meeting) and $meeting->in_person) or old('in_person') == 'on') ? '' :  'd-none' }}" id="inPersonMeetingAmount">
                    <label class="font-weight-500 font-14 text-light d-block">{{ trans('update.hourly_amount') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text text-light font-16">
                                {{ $currency }}
                ...
                <div class="col-12 mt-5 {{ ((!empty($meeting) and $meeting->group_meeting) or old('group_meeting') == 'on') ? '' :  'd-none' }}" id="onlineGroupMeetingOptions">
                    ...
                    <div class="row mt-15">
                        <div class="col-12 col-lg-3">
                            <label class="font-weight-500 font-14 text-light d-block">{{ trans('update.minimum_students') }}</label>
                        ...
                        <div class="col-12 col-lg-3">
                            <label class="font-weight-500 font-14 text-light d-block">{{ trans('update.maximum_students') }}</label>
