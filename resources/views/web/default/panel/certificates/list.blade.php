            ...
            <div class="row">
                <div class="col-6 col-lg-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark font-weight-bold mt-5">{{ $activeQuizzes }}</strong>
                ...
                <div class="col-6 col-lg-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark font-weight-bold mt-5">{{ $achievementsCount }}</strong>
                ...
                <div class="col-6 col-lg-3 d-flex align-items-center justify-content-center mt-5 mt-lg-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark font-weight-bold mt-5">{{ $failedResults }}</strong>
                ...
                <div class="col-6 col-lg-3 d-flex align-items-center justify-content-center mt-5 mt-lg-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark font-weight-bold mt-5">{{ $avgGrade }}</strong>
                            ...
                            <table class="table text-center custom-table">
                                ...
                                @foreach($quizzes as $quiz)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <span class="text-light font-weight-500">{{ round($quiz->avg_grade, 2) }}</span>
                                        </td>
                                        <td class="text-light font-weight-500 align-middle">{{ count($quiz->certificates) }}</td>
                                        <td class="align-middle">
                                            <span class="text-light font-weight-500">{{ dateTimeFormat($quiz->created_at, 'j M Y') }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
