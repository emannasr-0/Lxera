...
@section('content')
            ...
            <div class="row">
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-light font-weight-500 mt-5">{{ $certificatesCount }}</strong>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-light font-weight-500 mt-5">{{ $avgGrades }}</strong>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-light font-weight-500 mt-5">{{ $failedQuizzes }}</strong>
                        ...
                        <div class="table-responsive">
                            <table class="table text-center custom-table">
                                ...
                                @foreach($quizzes as $quiz)
                                    <tr>
                                        <td class="text-left">
                                            <span class="d-block text-light font-weight-500">{{ $quiz->title }}</span>
                                        ...
                                        <td class="align-middle">
                                            <span class="text-light font-weight-500">{{ $quiz->pass_mark }}</span>
                                        </td>
                                        <td class="align-middle">
                                            <span class="text-light font-weight-500">{{ $quiz->total_mark }}</span>
                                        </td>
                                        <td class="align-middle">{{ $quiz->result->user_grade }}</td>
                                        <td class="align-middle">
                                            <span class="text-light font-weight-500">{{ dateTimeFormat($quiz->result->created_at, 'j M Y') }}</span>
                                        </td>
    ...
    <section class="mt-35">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title">{{trans('panel.courses')}}</h2>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table text-center custom-table">
                                ...
                                @foreach($courseCertificates as $courseCertificate)
                                    <tr>
                                        <td class="text-left">
                                            <span class="d-block text-light font-weight-500">{{ $courseCertificate->title }}</span>
    ...
    <section class="mt-35">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title">{{trans('panel.programs')}}</h2>
        </div>
