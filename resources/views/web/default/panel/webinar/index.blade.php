...
@section('content')
    <section>
        ...
        <div class="activities-container mt-25 p-20 p-lg-35 bg-secondary-acadima shadow border">
            <div class="row">
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/default/img/activity/webinars.svg" width="64" height="64" alt="">
                        <strong
                            class="font-30 text-black font-weight-bold mt-5">{{ !empty($webinars) ? $webinarsCount : 0 }}</strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong
                            class="font-30 text-black font-weight-bold mt-5">{{ $webinarHours }}</strong>
                ...
                {{-- <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ handlePrice($webinarSalesAmount) }}</strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ handlePrice($courseSalesAmount) }}</strong>
                            ...
                            <div class="image-box">
                                ...
                                @switch($webinar->status)
                                    @case(\App\Models\Webinar::$active)
                                        @if ($webinar->isWebinar())
                                            @if ($webinar->start_date > time())
                                                <span class="badge badge-primary text-dark-blue">{{ trans('panel.not_conducted') }}</span>
                                            @elseif($webinar->isProgressing())
                                                <span class="badge badge-secondary text-dark-blue">{{ trans('webinars.in_progress') }}</span>
                                            @else
                                                <span class="badge badge-secondary text-dark-blue">{{ trans('public.finished') }}</span>
                                            @endif
                                        @else
                                            <span class="badge badge-secondary text-dark-blue">{{ trans('webinars.' . $webinar->type) }}</span>
                                        @endif
                                    @break

                                    @case(\App\Models\Webinar::$isDraft)
                                        <span class="badge badge-danger text-black">{{ trans('public.draft') }}</span>
                                    @break
                                    ...
                                    @case(\App\Models\Webinar::$inactive)
                                        <span class="badge badge-danger text-black">{{ trans('public.rejected') }}</span>
                                    @break
                                @endswitch
