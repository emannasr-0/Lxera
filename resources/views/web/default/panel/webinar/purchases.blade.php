...
<rect width="56" height="56" fill="white"/>
                        ...
                        <strong class=" js-font-resize font-30 text-light font-weight-bold mt-5"> {{ $totalWebinars }}</strong>
                 ...
                 <div class=" js-font-resize col-4 d-flex align-items-center justify-content-center">
                    <div class=" js-font-resize d-flex flex-column align-items-center text-center">
                        ...
                        <strong class=" js-font-resize font-30 text-light font-weight-bold mt-5">{{ convertMinutesToHourAndMinute($hours) }}</strong>
                ...
                <div class=" js-font-resize col-4 d-flex align-items-center justify-content-center">
                    <div class=" js-font-resize d-flex flex-column align-items-center text-center">
                        ...
                        <strong class=" js-font-resize font-30 text-light font-weight-bold mt-5">{{ $upComing }}</strong>
    ...
    <section class=" js-font-resize mt-25">
        @if (!empty($sales) and !$sales->isEmpty())
            <div
                class=" js-font-resize d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row mt-80">
                <h2 class=" js-font-resize section-title">الدورات المسجلة </h2>
            </div>
            @foreach ($sales as $sale)
                @php
                ...
                @if (!empty($item))
                    <section class=" js-font-resize mb-80">
                        <div class=" js-font-resize d-flex justify-content-between align-items-center mt-30">
                            <h2 class=" js-font-resize section-title after-line">{{ trans('product.course') }}
                                {{ $item->title }}</h2>
                        </div>
                        ...
                        @elseif (!$sale->webinar->isUserHasAccessToContent())
                            <p class=" js-font-resize text-center alert alert-warning" style="margin-top: 20px !important">
                                                    ...
                                                    <td>
                                                        @if ($item->duration != 0)
                                                            ...
                                                            <a target="_blank" rel="noopener noreferrer"
                                                                class=" js-font-resize btn btn-primary" style="width:190px;height:50px"
