...
@section('content')
    ...
    <section class=" js-font-resize mt-25">
        ...
        <div class=" js-font-resize panel-section-card py-20 px-25 mt-20">
            <form action="/panel/webinars/comments" method="get" class=" js-font-resize row">
    ...
    <section class=" js-font-resize mt-35">
        <div class=" js-font-resize d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class=" js-font-resize section-title">{{ trans('panel.webinar_comments_list') }}</h2>
        </div>
                        ...
                        <div class=" js-font-resize table-responsive">
                            <table class=" js-font-resize table custom-table text-center ">
                                ...
                                <tr>
                                    ...
                                    <th class=" js-font-resize text-left">{{ trans('panel.webinar') }}</th>
                                ...
                                @foreach($comments as $comment)
                                    <tr>
                                        ...
                                        <td class=" js-font-resize  text-left align-middle" width="35%">
                                            <a href="{{ $comment->webinar->getUrl() }}" target="_blank" class=" js-font-resize text-light font-weight-500">{{ $comment->webinar->title }}</a>
                                        </td>
                                        ...
                                        <td class=" js-font-resize align-middle text-right">
                                            ...
                                            <div class=" js-font-resize btn-group dropdown table-actions">
                                                ...
                                                <div class=" js-font-resize dropdown-menu">
                                                    ...
                                                    <button type="button" data-item-id="{{ $comment->webinar_id }}" data-comment-id="{{ $comment->id }}" class=" js-font-resize btn-transparent webinar-actions d-block mt-10 text-hover-primary report-comment">{{ trans('panel.report') }}</button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
