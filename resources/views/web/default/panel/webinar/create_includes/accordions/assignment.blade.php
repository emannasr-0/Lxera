<li data-id="{{ !empty($chapterItem) ? $chapterItem->id : '' }}"
    class="accordion-row bg-secondary-acadima rounded-sm border border-gray300 mt-20 py-15 py-lg-30 px-10 px-lg-20">
    <div class="d-flex align-items-center justify-content-between " role="tab"
        id="file_{{ !empty($assignment) ? $assignment->id : 'record' }}">
        <div class="d-flex align-items-center" href="#collapseFile{{ !empty($assignment) ? $assignment->id : 'record' }}"
            ...
            <span class="chapter-icon2 chapter-content-icon mr-10">
                <i data-feather="feather" class=""></i>
            </span>

            <div class="font-weight-bold text-black d-block">
    ...
    <div id="collapseFile{{ !empty($assignment) ? $assignment->id : 'record' }}"
        ...
        class=" collapse @if (empty($assignment)) show @endif" role="tabpanel">
        <div class="panel-collapse text-gray">
            <div class="js-content-form assignment-form"
                    ...
                    <div class="col-12 col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="ajax[{{ !empty($assignment) ? $assignment->id : 'new' }}][locale]"
                                    ...
                                    @foreach ($userLanguages as $lang => $language)
                                        <option value="{{ $lang }}"
                                            {{ (!empty($assignment) and !empty($assignment->locale)) ? (mb_strtolower($assignment->locale) == mb_strtolower($lang) ? 'selected' : '') : ($locale == $lang ? 'selected' : '') }}>
                                            {{ $language }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="ajax[{{ !empty($assignment) ? $assignment->id : 'new' }}][description]"
                                class="js-ajax-description form-control" rows="6">{{ !empty($assignment) ? $assignment->description : '' }}</textarea>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                class="js-ajax-grade form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                class="js-ajax-pass_grade form-control"
                        ...
                        {{-- <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                class="js-ajax-deadline form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                    ...
                                    class="js-ajax-deadline form-control datetimepicker"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                class="js-ajax-attempts form-control"
                        ...
                        <div class="js-assignment-attachments-items form-group mt-15">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <button type="button" class="btn btn-primary btn-sm assignment-attachments-add-btn">
                                    <i data-feather="plus" width="18" height="18" class="text-light"></i>
                                </button>
                            </div>
                                ...
                                <div class="mt-10 p-10 border rounded">
                                    ...
                                    <div class="input-group product-images-input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="attachments_assignmentTemp" value="" class="form-control"
                                            placeholder="{{ trans('update.assignment_attachments_placeholder') }}" />
                                    </div>
                                </div>

                                <button type="button"
                                    class="btn btn-danger btn-sm assignment-attachments-remove-btn d-none">
                                    <i data-feather="x" width="18" height="18" class="text-light"></i>
                                </button>
                            </div>
                                        ...
                                        <div class="mt-10 p-10 border rounded">
                                            <div class="mb-10">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $attachment->title }}" class="form-control"
                                                    placeholder="{{ trans('forms.maximum_255_characters') }}" />
                                            </div>
                                            ...
                                            <div class="input-group product-images-input-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $attachment->attach }}" class="form-control"
                                                    placeholder="{{ trans('update.assignment_attachments_placeholder') }}" />
                                            </div>
                                        </div>

                                        <button type="button"
                                            class="btn btn-danger btn-sm assignment-attachments-remove-btn">
                        ...
                        @if (getFeaturesSettings('sequence_content_status'))
                            {{-- <div class="form-group mt-20">
                                <div class="d-flex align-items-center justify-content-between">
                                    <label class="cursor-pointer input-label"
                                        for="SequenceContentSwitch{{ !empty($assignment) ? $assignment->id : '_record' }}">{{ trans('update.sequence_content') }}</label>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox"
                            ...
                            <div class="js-sequence-content-inputs pl-5">
                                <div class="form-group">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <label class="cursor-pointer input-label"
                                            for="checkPreviousPartsSwitch{{ !empty($assignment) ? $assignment->id : '_record' }}">{{ trans('update.check_previous_parts') }}</label>
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            class="js-ajax-access_after_day form-control datetimepicker"
                                            aria-describedby="dateInputGroupPrepend"
                ...
                <div class="mt-30 d-flex align-items-center">
                    <button type="button"
                        class="js-save-assignment btn btn-sm btn-primary">{{ trans('public.save') }}</button>
