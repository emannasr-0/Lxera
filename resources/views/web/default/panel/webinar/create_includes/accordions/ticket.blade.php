                        ...
                        <div class=" js-font-resize col-12 col-lg-6">
                            <div class=" js-font-resize form-group">
                                ...
                                <select name="ajax[{{ !empty($ticket) ? $ticket->id : 'new' }}][locale]"
                                        class=" js-font-resize form-control {{ !empty($ticket) ? 'js-webinar-content-locale' : '' }}"
                    ...
                    <div class=" js-font-resize col-12 col-lg-4">
                        ...
                        <div class=" js-font-resize form-group">
                            ...
                            @if(empty($ticket) and !empty($webinar->capacity) and !empty($sumTicketsCapacities))
                                <span class=" js-font-resize test-gray font-12 d-block">{{ trans('panel.remaining') }}: <span class=" js-font-resize js-ticket-remaining-capacity">{{ $webinar->capacity - $sumTicketsCapacities }}</span></span>
                            @endif

                            <input type="text" name="ajax[{{ !empty($ticket) ? $ticket->id : 'new' }}][capacity]" class=" js-font-resize js-ajax-capacity form-control mt-10" value="{{ !empty($ticket) ? $ticket->capacity :'' }}" placeholder="{{ $webinar->isWebinar() ? trans('webinars.empty_means_webinar_capacity') : trans('forms.empty_means_unlimited') }}"/>
                            <div class=" js-font-resize invalid-feedback"></div>
                        </div>
                    </div>
                </div>
