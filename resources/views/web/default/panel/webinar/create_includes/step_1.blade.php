    ...
    <div class=" js-font-resize col-12 col-md-4 mt-15">
        ...
        @if(!empty(getGeneralSettings('content_translate')))
            <div class=" js-font-resize form-group">
                ...
                <select name="locale" class=" js-font-resize custom-select {{ !empty($webinar) ? 'js-edit-content-locale' : '' }}">
        ...
        <div class=" js-font-resize form-group mt-15">
            ...
            <input type="text" name="title" value="{{ (!empty($webinar) and !empty($webinar->translate($locale))) ? $webinar->translate($locale)->title : old('title') }}" class=" js-font-resize form-control @error('title')  is-invalid @enderror" placeholder=""/>
            @error('title')
            <div class=" js-font-resize invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class=" js-font-resize form-group mt-15">
            ...
            <input type="text" name="seo_description" value="{{ (!empty($webinar) and !empty($webinar->translate($locale))) ? $webinar->translate($locale)->seo_description : old('seo_description') }}" class=" js-font-resize form-control @error('seo_description')  is-invalid @enderror " placeholder="{{ trans('forms.50_160_characters_preferred') }}"/>
        ...
        <div class=" js-font-resize form-group mt-15">
            ...
            <div class=" js-font-resize input-group">
                ...
                <input type="text" name="thumbnail" id="thumbnail" value="{{ !empty($webinar) ? $webinar->thumbnail : old('thumbnail') }}" class=" js-font-resize form-control @error('thumbnail')  is-invalid @enderror" placeholder="{{ trans('forms.course_thumbnail_size') }}"/>
                @error('thumbnail')
                <div class=" js-font-resize invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class=" js-font-resize form-group mt-15">
            ...
            <div class=" js-font-resize input-group">
                ...
                <input type="text" name="image_cover" id="cover_image" value="{{ !empty($webinar) ? $webinar->image_cover : old('image_cover') }}" placeholder="{{ trans('forms.course_cover_size') }}" class=" js-font-resize form-control @error('image_cover')  is-invalid @enderror"/>
                @error('image_cover')
                <div class=" js-font-resize invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class=" js-font-resize form-group mt-0">
            ...
            <div class=" js-font-resize input-group js-video-demo-path-input">
                <div class=" js-font-resize input-group-prepend">
                    <button type="button" class=" js-font-resize js-video-demo-path-upload input-group-text text-white panel-file-manager {{ (empty($webinar) or empty($webinar->video_demo_source) or $webinar->video_demo_source == 'upload') ? '' : 'd-none' }}" data-input="demo_video" data-preview="holder">
                        <i data-feather="upload" width="18" height="18" class=" js-font-resize text-white"></i>
                    </button>

                    <button type="button" class=" js-font-resize js-video-demo-path-links rounded-left input-group-text input-group-text-rounded-left text-white {{ (empty($webinar) or empty($webinar->video_demo_source) or $webinar->video_demo_source == 'upload') ? 'd-none' : '' }}">
                        <i data-feather="link" width="18" height="18" class=" js-font-resize text-white"></i>
                    </button>
                </div>
                <input type="text" name="video_demo" id="demo_video" value="{{ !empty($webinar) ? $webinar->video_demo : old('video_demo') }}" class=" js-font-resize form-control @error('video_demo')  is-invalid @enderror"/>
                @error('video_demo')
                <div class=" js-font-resize invalid-feedback">
                    {{ $message }}
                </div>
...
<div class=" js-font-resize row">
    <div class=" js-font-resize col-12">
        <div class=" js-font-resize form-group">
            ...
            <textarea id="summernote" name="description" class=" js-font-resize form-control @error('description')  is-invalid @enderror" placeholder="{{ trans('forms.webinar_description_placeholder') }}">{!! (!empty($webinar) and !empty($webinar->translate($locale))) ? $webinar->translate($locale)->description : old('description')  !!}</textarea>
            @error('description')
            <div class=" js-font-resize invalid-feedback">
                {{ $message }}
            </div>
