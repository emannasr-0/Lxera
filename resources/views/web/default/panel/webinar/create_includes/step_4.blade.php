...
<section class=" js-font-resize mt-50">
    <div class=" js-font-resize ">
        <h2 class=" js-font-resize section-title after-line">{{ trans('public.chapters') }} ({{ trans('public.optional') }})</h2>
    </div>

    <button type="button" class=" js-font-resize js-add-chapter btn btn-primary btn-sm mt-15" data-webinar-id="{{ $webinar->id }}">{{ trans('public.new_chapter') }}</button>

    @include('web.default.panel.webinar.create_includes.accordions.chapter')
</section>

@if($webinar->isWebinar())
    <div id="newSessionForm" class=" js-font-resize d-none">
...
@if(getFeaturesSettings('new_interactive_file'))
    <div id="newInteractiveFileForm" class=" js-font-resize d-none">
        @include('web.default.panel.webinar.create_includes.accordions.new_interactive_file',['webinar' => $webinar])
    </div>
@endif


<div id="newTextLessonForm" class=" js-font-resize d-none">
...
@if(getFeaturesSettings('webinar_assignment_status'))
    <div id="newAssignmentForm" class=" js-font-resize d-none">
