...
@section('content')
            ...
            <div class=" js-font-resize row">
                <div class=" js-font-resize col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class=" js-font-resize d-flex flex-column align-items-center text-center">
                        ...
                        <span class=" js-font-resize font-16 text-light text-gray font-weight-500">{{ trans('update.course_assignments') }}</span>
                    </div>
                </div>
                ...
                <div class=" js-font-resize col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class=" js-font-resize d-flex flex-column align-items-center text-center">
                        ...
                        <span class=" js-font-resize font-16 text-light text-gray font-weight-500">{{ trans('update.pending_review') }}</span>
                    </div>
                </div>

                <div class=" js-font-resize col-6 col-md-3 mt-30 mt-md-0 mt-5 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class=" js-font-resize d-flex flex-column align-items-center text-center">
    ...
    <section class=" js-font-resize mt-25">
        ...
        <div class=" js-font-resize panel-section-card py-20 px-25 mt-20">
            <form action="/panel/assignments/my-assignments" method="get" class=" js-font-resize row">
                ...
                <div class=" js-font-resize col-12 col-lg-6">
                    <div class=" js-font-resize row">
                        <div class=" js-font-resize col-12 col-lg-8">
                            <div class=" js-font-resize form-group">
                                <label class=" js-font-resize input-label text-dark">{{ trans('product.course') }}</label>
    ...
    <section class=" js-font-resize mt-35">
        <div class=" js-font-resize d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class=" js-font-resize section-title">{{ trans('update.my_assignments') }}</h2>
        </div>
                                ...
                                @foreach($assignments as $assignment)
                                    <tr>
                                        ...
                                        <td class=" js-font-resize align-middle">
                                            <span class=" js-font-resize font-weight-500">{{ !empty($assignment->deadline) ? dateTimeFormat($assignment->deadlineTime, 'j M Y') : '-' }}</span>
                                        </td>

                                        <td class=" js-font-resize align-middle">
                                            <span class=" js-font-resize font-weight-500">{{ !empty($assignment->first_submission) ? dateTimeFormat($assignment->first_submission, 'j M Y | H:i') : '-' }}</span>
                                        </td>

                                        <td class=" js-font-resize align-middle">
                                            <span class=" js-font-resize font-weight-500">{{ !empty($assignment->last_submission) ? dateTimeFormat($assignment->last_submission, 'j M Y | H:i') : '-' }}</span>
                                        </td>

                                        <td class=" js-font-resize align-middle">
                                            <span class=" js-font-resize font-weight-500">{{ !empty($assignment->attempts) ? "{$assignment->usedAttemptsCount}/{$assignment->attempts}" : '-' }}</span>
                                        </td>
                                        ...
                                        <td class=" js-font-resize align-middle text-right">
                                            ...
                                            <div class=" js-font-resize btn-group dropdown table-actions">
                                                ...
                                                <div class=" js-font-resize dropdown-menu menu-lg">
                                                    ...
                                                    @else
                                                        <a href="#!" class=" js-font-resize not-access-toast webinar-actions d-block mt-10 font-weight-normal">{{ trans('update.view_assignment') }}</a>
                                                    @endif
                                                </div>
                                            </div>
