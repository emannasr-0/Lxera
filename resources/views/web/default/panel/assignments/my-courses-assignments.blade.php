            ...
            <div class="row">
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 font-weight-bold mt-5 text-dark">{{ $courseAssignmentsCount }}</strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 font-weight-bold mt-5 text-dark">{{ $pendingReviewCount }}</strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark font-weight-bold mt-5">{{ $passedCount }}</strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark font-weight-bold mt-5">{{ $failedCount }}</strong>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-dark">
                                            @switch($assignment->status)
                                                @case('active')
                                                <span class="text-dark font-weight-500">{{ trans('public.active') }}</span>
                                                @break
                                                @case('inactive')
                                        ...
                                        <td class="align-middle text-right text-dark">
                                            ...
                                            <div class="btn-group dropdown table-actions">
                                                <button type="button" class="btn-transparent dropdown-toggle text-black"
