...
@section('content')
            ...
            <div class="row">
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ $openSupportsCount }}</strong>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ $closeSupportsCount }}</strong>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-black font-weight-bold mt-5">{{ $supportsCount }}</strong>
    ...
    <section class="mt-40">
        ...
        @if(!empty($supports) and !$supports->isEmpty())
            ...
            <div class="bg-secondary-acadima shadow rounded-sm py-10 py-lg-25 px-15 px-lg-30 mt-25">
                <div class="row">
                            ...
                            <table class="table table-md">
                                ...
                                @foreach($supports as $support)
                                    <tr class="@if(!empty($selectSupport) and $selectSupport->id == $support->id) selected-row @endif">
                                        ...
                                        <td class="text-center align-middle">
                                            <span class="font-weight-500 text-light font-14 text-gray d-block">{{ (!empty($support->conversations) and count($support->conversations)) ? dateTimeFormat($support->conversations->first()->created_at,'j M Y | H:i') : dateTimeFormat($support->created_at,'j M Y | H:i') }}</span>
                                        </td>
                                        ...
                                        <div class="rounded-sm mt-15 border panel-shadow p-15">
                                            <div class="d-flex align-items-center justify-content-between pb-20 border-bottom border-gray300">
                                                ...
                                                <div class="d-flex flex-column align-items-end">
                                                    <span class="font-12 text-light">{{ dateTimeFormat($conversations->created_at,'j M Y | H:i') }}</span>
