    ...
    <div class=" js-font-resize col-12 col-md-4 mt-15">
        ...
        @if(!empty(getGeneralSettings('content_translate')))
            <div class=" js-font-resize form-group">
                ...
                <select name="locale" class=" js-font-resize custom-select {{ !empty($bundle) ? 'js-edit-content-locale' : '' }}">
        ...
        <div class=" js-font-resize form-group mt-15">
            ...
            <input type="text" name="title" value="{{ (!empty($bundle) and !empty($bundle->translate($locale))) ? $bundle->translate($locale)->title : old('title') }}" class=" js-font-resize form-control @error('title')  is-invalid @enderror" placeholder=""/>
            @error('title')
            <div class=" js-font-resize invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class=" js-font-resize form-group mt-15">
            ...
            <input type="text" name="seo_description" value="{{ (!empty($bundle) and !empty($bundle->translate($locale))) ? $bundle->translate($locale)->seo_description : old('seo_description') }}" class=" js-font-resize form-control @error('seo_description')  is-invalid @enderror " placeholder="{{ trans('forms.50_160_characters_preferred') }}"/>
        ...
        <div class=" js-font-resize form-group mt-15">
            ...
            <div class=" js-font-resize input-group">
                ...
                <input type="text" name="thumbnail" id="thumbnail" value="{{ !empty($bundle) ? $bundle->thumbnail : old('thumbnail') }}" class=" js-font-resize form-control @error('thumbnail')  is-invalid @enderror" placeholder="{{ trans('forms.course_thumbnail_size') }}"/>
                @error('thumbnail')
                <div class=" js-font-resize invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class=" js-font-resize form-group mt-15">
            ...
            <div class=" js-font-resize input-group">
                ...
                <input type="text" name="image_cover" id="cover_image" value="{{ !empty($bundle) ? $bundle->image_cover : old('image_cover') }}" placeholder="{{ trans('forms.course_cover_size') }}" class=" js-font-resize form-control @error('image_cover')  is-invalid @enderror"/>
                @error('image_cover')
                <div class=" js-font-resize invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class=" js-font-resize form-group mt-0">
            ...
            <div class=" js-font-resize input-group js-video-demo-path-input">
                <div class=" js-font-resize input-group-prepend">
                    <button type="button" class=" js-font-resize js-video-demo-path-upload input-group-text text-white panel-file-manager {{ (empty($bundle) or empty($bundle->video_demo_source) or $bundle->video_demo_source == 'upload') ? '' : 'd-none' }}" data-input="demo_video" data-preview="holder">
                        <i data-feather="upload" width="18" height="18" class=" js-font-resize text-white"></i>
                    </button>

                    <button type="button" class=" js-font-resize js-video-demo-path-links rounded-left input-group-text input-group-text-rounded-left text-white {{ (empty($bundle) or empty($bundle->video_demo_source) or $bundle->video_demo_source == 'upload') ? 'd-none' : '' }}">
                        <i data-feather="link" width="18" height="18" class=" js-font-resize text-white"></i>
                    </button>
                </div>
                <input type="text" name="video_demo" id="demo_video" value="{{ !empty($bundle) ? $bundle->video_demo : old('video_demo') }}" class=" js-font-resize form-control @error('video_demo')  is-invalid @enderror"/>
                @error('video_demo')
                <div class=" js-font-resize invalid-feedback">
                    {{ $message }}
                </div>
...
<div class=" js-font-resize row">
    <div class=" js-font-resize col-12">
        <div class=" js-font-resize form-group">
            ...
            <textarea id="summernote" name="description" class=" js-font-resize form-control @error('description')  is-invalid @enderror" placeholder="{{ trans('forms.webinar_description_placeholder') }}">{!! (!empty($bundle) and !empty($bundle->translate($locale))) ? $bundle->translate($locale)->description : old('description')  !!}</textarea>
            @error('description')
            <div class=" js-font-resize invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class=" js-font-resize row">
        <div class=" js-font-resize col-6">
            ...
            <div class=" js-font-resize form-group mt-30 d-flex align-items-center">
                <label class=" js-font-resize cursor-pointer mb-0 input-label" for="privateSwitch">{{ trans('webinars.private') }}</label>
                <div class=" js-font-resize ml-30 custom-control custom-switch">
                    <input type="checkbox" name="private" class=" js-font-resize custom-control-input" id="privateSwitch" {{ (!empty($bundle) and $bundle->private) ? 'checked' :  '' }}>
                    <label class=" js-font-resize custom-control-label" for="privateSwitch"></label>
                </div>
            </div>

            <p class=" js-font-resize text-gray font-12">{{ trans('webinars.create_private_course_hint') }}</p>
        </div>
    </div>
@endif
