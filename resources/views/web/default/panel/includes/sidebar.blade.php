...
<div class="xs-panel-nav d-flex d-lg-none justify-content-between p-15   ">
    <div class="user-info d-flex align-items-center justify-content-between">
        <div class="" style="max-width: 40px;">
            ...
            <img src="{{ asset('store/Acadima/reviwebg.png') }}" class="img-cover" alt="{{ $authUser->full_name }}">

        </div>

        <div class="user-name ml-15">
            <h3 class="font-16 font-weight-bold text-color">{{ $authUser->full_name }}</h3>
        </div>
    </div>
...
<div class="panel-sidebar pt-50 pb-25 px-25   " id="panelSidebar" style="overflow: auto">
    ...
    <div class="user-info d-flex align-items-center flex-row flex-lg-column justify-content-lg-center gap-3">
        <a href="/panel" class="p-3">
            <img src="{{ asset('store/Acadima/reviwebg.png') }}"  class="" alt="{{ $authUser->full_name }}"   style="max-width: 60px;">
        </a>

        <div class="d-flex flex-column align-items-center justify-content-center">
            <a href="/panel" class="user-name mt-15">
                <h3 class="font-16 font-weight-bold text-center text-color">{{ $authUser->full_name }}</h3>
                <h3 class="font-16 font-weight-bold text-center text-color">{{ $authUser->user_code }}</h3>
            </a>
