...
@push('scripts_bottom')
    ...
    <!---->
      ...
      <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"></script>
        <script>
            function showPopup(identifier, price, name) {
                 console.log('Identifier:', identifier);
                $('#coursePopup' + identifier).modal('show');
        
                // Set the price and name in the modal body
                $('#coursePopup' + identifier + ' .modal-body').html('هل انت تريد شراء شهادة ' + name + ' مقابل ' + price + ' ريال سعودي');
            }
        
            function acceptPurchase(identifier) {
                $('#coursePopup' + identifier).modal('hide');
            }
        </script>
