    ...
    <figure>
        <div class="image-box">
            @if($webinar->bestTicket() < $webinar->price)
                <span class="badge badge-danger text-light">{{ trans('public.offer',['off' => $webinar->bestTicket(true)['percent']]) }}</span>
            @elseif(empty($isFeature) and !empty($webinar->feature))
                <span class="badge badge-warning text-dark-blue">{{ trans('home.featured') }}</span>
            ...
            @elseif(!empty($webinar->type))
                <span class="badge badge-primary text-dark-blue">{{ trans('webinars.'.$webinar->type) }}</span>
            @endif
        ...
        <figcaption class="webinar-card-body">
            ...
            <a href="{{ $webinar->getUrl() }}">
                <h3 class="mt-15 webinar-title font-weight-bold font-16 text-light">{{ clean($webinar->title,'title') }}</h3>
            </a>
