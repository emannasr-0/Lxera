<section class="p-15 m-15 border rounded-lg bg-secondary-acadima">
    <div class="assignment-top-stats d-flex flex-wrap flex-md-nowrap align-items-start align-items-lg-center justify-content-start justify-content-md-around">
        <div class="col-6 col-md-2 assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="/assets/default/img/activity/calendar.svg" class="assignment-top-stats__icon" alt="">
                <span class="font-20 text-black font-weight-bold mt-20">
                    {{ dateTimeFormat($assignment->deadline, 'j M Y') }}
                    </span>

                <strong class="font-20 text-black font-weight-bold mt-5">
        ...
        <div class="col-6 col-md-2 assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0 mt-30 mt-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="/assets/default/img/activity/45.svg" class="assignment-top-stats__icon" alt="">
                <strong class="font-20 text-black font-weight-bold mt-5">{{ $assignmentHistory->grade ?? 0 }}/{{ $assignment->grade }}</strong>
        ...
        <div class="col-6 col-md-2 assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0 mt-30 mt-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                ...
                <strong class="font-20 text-black font-weight-bold mt-5">{{ $assignment->pass_grade }}</strong>
        ...
        <div class="col-6 col-md-2 assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0 mt-30 mt-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                ...
                <strong class="font-20 text-black font-weight-bold mt-5">{{ trans('update.assignment_history_status_'.$assignmentHistory->status) }}</strong>
                <span class="font-14 text-gray font-weight-500">{{ trans('public.status') }}</span>
            </div>
        </div>
    </div>

    <div class="p-15 rounded-lg bg-info font-14 text-gray mt-20">{!! $assignment->description !!}</div>
</section>
                ...
                <div class="col-6 col-lg-3 mt-10">
                    <a href="{{ $attachment->getDownloadUrl() }}" target="_blank" class="d-flex align-items-center p-10 border rounded-sm">
                        <span class="chapter-icon bg-acadima-pink mr-10">
                            <i data-feather="file" class="text-light" width="16" height="16"></i>
                        </span>
...
<section class="mt-25 container-fluid">
    ...
    <section class=" p-10 my-10 border rounded-lg bg-secondary-acadima">
        <div class="row">
            <div class="col-12 col-lg-4">
                @if(
                    ...
                    <div class="d-flex align-items-center justify-content-center flex-column bg-secondary-acadima p-10 rounded-sm border h-100">
                        ...
                        <div class="d-flex align-items-center flex-column mt-10 text-center">
                            @if($assignmentHistory->status == \App\Models\WebinarAssignmentHistory::$passed)
                                <h3 class="font-20 font-weight-bold text-pink text-center">{{ trans('update.assignment_passed_title') }}</h3>
                                <p class="mt-5 text-gray font-14 text-center">{{ trans('update.assignment_passed_desc') }}</p>
                            @elseif($assignmentHistory->status == \App\Models\WebinarAssignmentHistory::$notPassed)
                                <h3 class="font-20 font-weight-bold text-pink text-center">{{ trans('update.assignment_not_passed_title') }}</h3>
                                <p class="mt-5 text-gray font-14 text-center">{{ trans('update.assignment_not_passed_desc') }}</p>
                            @elseif(!$assignmentDeadline)
                                <h3 class="font-20 font-weight-bold text-pink text-center">{{ trans('update.assignment_deadline_error_title') }}</h3>
                                <p class="mt-5 text-gray font-14 text-center">{{ trans('update.assignment_deadline_error_desc') }}</p>
                            @else
                                <h3 class="font-20 font-weight-bold text-pink text-center">{{ trans('update.assignment_submission_error_title') }}</h3>
                                <p class="mt-5 text-gray font-14 text-center">{{ trans('update.assignment_submission_error_desc') }}</p>
                            @endif
                        </div>
                    </div>
                @else
                    <div class="bg-secondary-acadima p-10 rounded-sm border">
                                    ...
                                    <div class="input-group mr-10">
                                        <div class="input-group-prepend">
                                            <button type="button" class="input-group-text panel-file-manager" data-input="assignmentAttachmentInput" data-preview="holder">
                                                <i data-feather="upload" width="18" height="18" class="text-light"></i>
                                            </button>
                                        </div>
                    ...
                    @if($user->id == $assignment->creator_id)
                        <div class="bg-secondary-acadima p-10 rounded-sm border mt-15">
                            <h4 class="font-16 font-weight-bold text-dark">{{ trans('update.rate_the_assignment') }}</h4>
                ...
                <div class="h-100">
                    ...
                    @else
                        <div class="d-flex align-items-center justify-content-center flex-column h-100">
                            ...
                            <div class="d-flex align-items-center flex-column mt-10 text-center">
                                <h3 class="font-20 font-weight-bold text-pink text-center">{{ trans('update.no_assignment') }}</h3>
