...
<div class=" js-font-resize learning-content bg-primary-acadima" id="learningPageContent">
    ...
    <div class=" js-font-resize learning-content-loading align-items-center justify-content-center flex-column w-100 h-100 {{ $showLoading ? 'd-flex' : 'd-none' }}">
        <img src="/assets/default/img/loading.gif" alt="">
        <p class=" js-font-resize mt-10">{{ trans('update.please_wait_for_the_content_to_load') }}</p>
    </div>
</div>
