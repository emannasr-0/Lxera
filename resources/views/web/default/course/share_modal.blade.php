<div class=" js-font-resize d-none" id="courseShareModal">
    ...
    <div class=" js-font-resize text-center">
        ...
        <div class=" js-font-resize position-relative d-flex align-items-center justify-content-between p-15 mt-15 border border-gray250 rounded-sm mt-5">
            <div class=" js-font-resize js-course-share-link font-weight-bold px-16 text-ellipsis font-14">{{ $course->getUrl() }}</div>
        ...
        <div class=" js-font-resize mt-32 mt-lg-40 row align-items-center font-14">
            <a href="{{ $course->getShareLink('telegram') }}" target="_blank" class=" js-font-resize col text-center">
            ...
            <a href="{{ $course->getShareLink('whatsapp') }}" target="_blank" class=" js-font-resize col text-center">
            ...
            <a href="{{ $course->getShareLink('facebook') }}" target="_blank" class=" js-font-resize col text-center">
            ...
            <a href="{{ $course->getShareLink('twitter') }}" target="_blank" class=" js-font-resize col text-center">
