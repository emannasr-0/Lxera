...
<style>
    ...
    <div class="p-3 p-lg-5 m-md-3 bg-secondary-acadima border-radius-lg col-sm-7 col-md-8 col-lg-4 shadow border  " >
        ...
        <h1 class="font-20 font-weight-bold m-3 ltr" style="display: flex; align-items: center; gap: 8px;">
        ...
        <form method="POST" action="/login?{{  request()->getQueryString() }}" class="needs-validation" novalidate="">
            ...
            <div class="text-right forgetpw d-flex justify-content-end text-center text-secondary ltr">
                <a href="/forget-password" target="_blank" class="text-color mb-30">Forgot password?</a>
        ...
        <div class="mt-20 text-center registertext ltr">
            ...
            <br>
            <a href="/register?{{  request()->getQueryString() }}" class="font-weight-bold text-color">
                <!-- {{ trans('auth.signup') }} -->
                  Register
            </a>
        </div>
