...
@section('body')
    <td class=" js-font-resize social-title pb-30"
        ...
        <div mc:edit="text_33" style="color: #333; direction: rtl !important; padding:20px;">
            ...
            <div class=" js-font-resize alert alert-success text-light" style="font-family: cairo, sans-serif; direction: rtl !important; text-align: left; color: #000;">
                <p  role="alert">
