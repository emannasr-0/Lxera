...
.select-border-radius {
    ...
    <div class=" js-font-resize px-3 px-lg-5 py-2 m-md-3 bg-secondary-acadima col-sm-7 col-md-8 col-lg-4 border-radius-lg ltr border shadow">
        <div class=" js-font-resize col-6 col-md-6 p-0 mb-0 mb-lg-5 mt-3 mt-md-auto mx-auto d-flex flex-column align-items-center">
            <img src="{{ asset('store/Acadima/acadima-logo.webp') }}" alt="logo" width="100%" class=" js-font-resize ">
            <h1 class=" js-font-resize font-20 font-weight-bold mb-3 mt-3 ltr">
        ...
        <form method="post" action="/register" class=" js-font-resize mt-35" id="registerForm">
...
<!-- 
        ...
        <div class=" js-font-resize mt-20 text-center registertext ltr">
            <span>
                ...
                <br>
                <a href="/login?{{  request()->getQueryString() }}" class=" js-font-resize text-cyan font-weight-bold">Login</a>
            </span>
        </div>
