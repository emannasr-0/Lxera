...
@section('content')
    ...
    @endphp
    <div class=" js-font-resize px-3 px-lg-5 py-2 m-md-3 bg-secondary-acadima col-sm-7 col-md-8 col-lg-4 border-radius-lg ltr border shadow">
        <div class=" js-font-resize col-6 col-md-6 p-0 mb-0 mb-lg-5 mt-3 mt-md-auto mx-auto d-flex flex-column align-items-center">
            <img src="{{ asset('store/Acadima/logo2.webp') }}" alt="logo" width="80%" class=" js-font-resize ">
            
        </div>

        <h1 class=" js-font-resize font-20 font-weight-bold mb-3 mt-3 ltr" style="display: flex; align-items: center; gap: 8px;">
        ...
        @if (!empty(session()->has('msg')))
            <div class=" js-font-resize alert alert-info alert-dismissible fade show mt-30 text-black" role="alert">
                {{ session()->get('msg') }}
                <button type="button" class=" js-font-resize close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
        @endif

        <form method="post" action="/register" class=" js-font-resize mt-20" id="registerForm">
            ...
            <!-- <div class=" js-font-resize form-group">
                <label class=" js-font-resize input-label text-light" for="full_name">الأسم الثلاثي باللغة العربية  *</label>

                <input name="full_name" type="text" value="{{ old('full_name') }}"
                    class=" js-font-resize form-control @error('full_name') is-invalid @enderror" placeholder="أدخل الأسم ">
                @error('full_name')
            ...
            <div class=" js-font-resize form-group ltr">
                <!-- <label class=" js-font-resize input-label text-light" for="en_name">Full Name   *</label> -->
                
                <div class=" js-font-resize border-radius-lg input-size form-control input-flex">
                    <img src="{{ asset('store/Images/Registration/User_01.svg') }}" alt="Mail" class=" js-font-resize mb-1">
                    <input name="en_name" type="text" value="{{ old('en_name') }}"
                    class=" js-font-resize form-control @error('en_name') is-invalid @enderror border-none" placeholder="Full Name">
                </div>
            ...
            @else
                ...
                <!-- <div class=" js-font-resize form-group">
                    <label class=" js-font-resize input-label text-light" for="email">اعد كتابة الإيميل
                        {{ !empty($optional) ? '(' . trans('public.optional') . ')' : '' }}*</label>
                    <input name="email_confirmation" type="text"
                        class=" js-font-resize form-control @error('email_confirmation') is-invalid @enderror"
            ...
            <div class=" js-font-resize password-section">

                <div class=" js-font-resize form-group col-12 p-0 ltr">
                    <!-- <label class=" js-font-resize input-label text-light" for="password">{{ trans('auth.password') }}:</label> -->
                    <div class=" js-font-resize border-radius-lg input-size form-control input-flex">
                        <img src="{{ asset('store/Images/Registration/Lock.svg') }}" alt="Mail" class=" js-font-resize mb-1">

                        <input name="password" type="password" class=" js-font-resize form-control @error('password') is-invalid @enderror border-none"
                            id="password" aria-describedby="passwordHelp" placeholder="Password">
                        <span class=" js-font-resize icon2" onclick="togglePasswordVisibility()">
                            <img id="toggleIcon" src="{{ asset('store/Images/Registration/Show.svg') }}" alt="Show" class=" js-font-resize icon2">
                        </span>
                    </div>
...
<!-- 
                <div class=" js-font-resize form-group  col-12 p-0 pr-1 ">
                    <label class=" js-font-resize input-label text-light" for="confirm_password">{{ trans('auth.retype_password') }}:</label>
                    <input name="password_confirmation" type="password"
                        class=" js-font-resize form-control @error('password_confirmation') is-invalid @enderror" id="confirm_password"
            ...
            {{-- @if (getFeaturesSettings('timezone_in_register'))
                ...
                <div class=" js-font-resize form-group">
                    <label class=" js-font-resize input-label text-light">{{ trans('update.timezone') }}</label>
            ...
            @if (!empty($referralSettings) and $referralSettings['status'])
                <div class=" js-font-resize form-group ">
                    <label class=" js-font-resize input-label text-light" for="referral_code">{{ trans('financial.referral_code') }}:</label>
                    <input name="referral_code" type="text"
                        class=" js-font-resize form-control @error('referral_code') is-invalid @enderror" id="referral_code"
            ...
            {{-- <div class=" js-font-resize custom-control custom-checkbox">
                <input type="checkbox" name="term" value="1"
                    ...
                    class=" js-font-resize custom-control-input @error('term') is-invalid @enderror" id="term">
                <label class=" js-font-resize custom-control-label font-14 mr-20" for="term">
                    <p class=" js-font-resize term">
                        {{ trans('auth.i_agree_with') }}

                        <a href="pages/terms" target="_blank"
                            class=" js-font-resize text-secondary font-weight-bold font-14">{{ trans('auth.terms_and_rules') }}</a>
            ...
            {{-- application type --}}
           {{-- <div class=" js-font-resize form-group">
                <!-- <label class=" js-font-resize form-label text-light">Type<span class=" js-font-resize text-danger">*</span></label> -->
                <select id="typeSelect" name="type" required 
                class=" js-font-resize form-control @error('type') is-invalid @enderror select-border-radius"
            ...
            {{-- course --}}
            {{-- <div class=" js-font-resize form-group">
                <!-- <label for="application2" class=" js-font-resize form-label" id="all_course">الدورات    التدربيه<span class=" js-font-resize text-danger">*</span></label> -->
                <select id="mySelect2" name="webinar_id" class=" js-font-resize form-control @error('webinar_id') is-invalid @enderror select-border-radius">
            ...
            <section class=" js-font-resize " id="diplomas_section">
                <div class=" js-font-resize form-group mt-15">
                    <!-- <label class=" js-font-resize input-label text-light">البرنامج</label> -->

                    <select id="bundle_id" class=" js-font-resize custom-select @error('bundle_id')  is-invalid @enderror select-border-radius"
                        name="bundle_id">
            ...
            <div class=" js-font-resize form-group d-flex flex-row justify-content-start mt-30">
                <button type="submit" class=" js-font-resize btn bg-button-acadima btn-lg cs-btn btn-border-radius mr-auto">
                    Register</i>
                </button>
            </div>
        ...
        <div class=" js-font-resize mt-20 text-center registertext ltr">
            <span>
                 Already have an account?
                <br>
                <a href="/login?{{  request()->getQueryString() }}" class=" js-font-resize text-pink font-weight-bold">Login</a>
            </span>
        </div>
