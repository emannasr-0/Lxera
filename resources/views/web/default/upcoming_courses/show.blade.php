...
@section('content')
    <section class=" js-font-resize course-cover-container bg-gray200">
        <img src="{{ $upcomingCourse->getImageCover() }}" class=" js-font-resize img-cover course-cover-img" alt="{{ $upcomingCourse->title }}"/>
    </section>

    <section class=" js-font-resize container course-content-section">
        <div class=" js-font-resize row">
            <div class=" js-font-resize col-12 col-lg-8">
                <div class=" js-font-resize course-content-body user-select-none">
                    <div class=" js-font-resize upcoming-course-body-on-cover d-flex flex-column text-white pb-15">
                        ...
                        @if(!empty($upcomingCourse->category))
                            <span class=" js-font-resize d-block font-16 mt-10">{{ trans('public.in') }} <a href="{{ $upcomingCourse->category->getUrl() }}" target="_blank" class=" js-font-resize font-weight-500 text-decoration-underline text-white">{{ $upcomingCourse->category->title }}</a></span>
                        @endif

                        <div class=" js-font-resize mt-15">
                            <span class=" js-font-resize font-14">{{ trans('public.created_by') }}</span>
                            <a href="{{ $upcomingCourse->teacher->getProfileUrl() }}" target="_blank" class=" js-font-resize text-decoration-underline text-white font-14 font-weight-500">{{ $upcomingCourse->teacher->full_name }}</a>
                        </div>

                        <div class=" js-font-resize mt-auto">
                            @if(!empty($followingUsers) and count($followingUsers))
                                <div class=" js-font-resize d-flex align-items-center mt-40">
                                    <div class=" js-font-resize d-flex align-items-center overlay-avatars">
                                        @foreach($followingUsers as $followingUser)
                                            <div class=" js-font-resize overlay-avatars__item size-40 rounded-circle">
                                                <img src="{{ $followingUser->user->getAvatar(40) }}" alt="{{ $followingUser->full_name }}" class=" js-font-resize img-cover rounded-circle">
                                            </div>
                                        @endforeach

                                        @if($followingUsersCount - $followingUsers->count() > 0)
                                            <div class=" js-font-resize overlay-avatars__count size-40 rounded-circle d-flex align-items-center justify-content-center font-14 text-gray">
                                                +{{ $followingUsersCount - $followingUsers->count() }}
                                            </div>
                                        @endif
                                    </div>
                                    <div class=" js-font-resize ml-5">
                                        <span class=" js-font-resize d-block font-14 font-weight-bold text-white">{{ $followingUsersCount }} {{ trans('panel.users') }}</span>
                                        <span class=" js-font-resize d-block font-12 text-white">{{ trans('update.are_following_this_upcoming_course') }}</span>
                                    </div>
                                </div>
                            @endif
                        </div>
            ...
            <div class=" js-font-resize course-content-sidebar col-12 col-lg-4 mt-25 mt-lg-0">
                <div class=" js-font-resize rounded-lg shadow-sm">
                    <div class=" js-font-resize course-img {{ $upcomingCourse->video_demo ? 'has-video' :'' }}">
                    ...
                    <div class=" js-font-resize px-20 pb-30">
                        ...
                        @if(!empty($upcomingCourse->webinar_id))
                            <a href="{{ $upcomingCourse->webinar->getUrl() }}" class=" js-font-resize btn btn-primary btn-block mt-20">{{ trans('update.view_course') }}</a>
                        @else
                            @if(!empty($authUser))
                                <button type="button" class=" js-font-resize js-follow-upcoming-course btn btn-primary btn-block mt-20" data-path="/upcoming_courses/{{ $upcomingCourse->slug }}/toggleFollow">
                                    {{ $followed ? trans('update.unfollow_course') : trans('update.follow_course') }}
                                </button>
                            @else
                                <a href="/login" class=" js-font-resize btn btn-primary btn-block mt-20">{{ trans('update.follow_course') }}</a>
                            @endif
                        @endif
                        ...
                        <div class=" js-font-resize mt-20 d-flex align-items-center justify-content-center text-gray">
                            ...
                            <span class=" js-font-resize ml-5 font-14">{{ trans('update.youll_get_notified_about_course_publish') }}</span>
                        </div>

                        <div class=" js-font-resize mt-35">
                            <strong class=" js-font-resize d-block text-secondary font-weight-bold">{{ trans('update.this_course_includes') }}:</strong>
                            ...
                            @if($upcomingCourse->downloadable)
                                <div class=" js-font-resize mt-20 d-flex align-items-center text-gray">
                                    ...
                                    <span class=" js-font-resize ml-5 font-14 font-weight-500">{{ trans('webinars.downloadable_content') }}</span>
                                </div>
                            @endif
                            ...
                            @if($upcomingCourse->certificate)
                                <div class=" js-font-resize mt-20 d-flex align-items-center text-gray">
                                    ...
                                    <span class=" js-font-resize ml-5 font-14 font-weight-500">{{ trans('webinars.official_certificate') }}</span>
                                </div>
                            @endif
                            ...
                            @if($upcomingCourse->include_quizzes)
                                <div class=" js-font-resize mt-20 d-flex align-items-center text-gray">
                                    ...
                                    <span class=" js-font-resize ml-5 font-14 font-weight-500">{{ trans('quiz.quizzes') }}</span>
                                </div>
                            @endif
                            ...
                            @if($upcomingCourse->support)
                                <div class=" js-font-resize mt-20 d-flex align-items-center text-gray">
                                    ...
                                    <span class=" js-font-resize ml-5 font-14 font-weight-500">{{ trans('webinars.instructor_support') }}</span>
                                </div>
                            @endif
                            ...
                            @if($upcomingCourse->forum)
                                <div class=" js-font-resize mt-20 d-flex align-items-center text-gray">
                                    <i data-feather="headphones" width="20" height="20"></i>
                                    <span class=" js-font-resize ml-5 font-14 font-weight-500">{{ trans('update.course_forum') }}</span>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class=" js-font-resize mt-40 p-10 rounded-sm border row align-items-center favorites-share-box">
                            @if(!empty($upcomingCourse->publish_date))
                                <div class=" js-font-resize col">
                                    <a href="{{ $upcomingCourse->addToCalendarLink() }}" target="_blank" class=" js-font-resize d-flex flex-column align-items-center text-center text-gray">
                            ...
                            <div class=" js-font-resize col">
                                <a href="/upcoming_courses/{{ $upcomingCourse->slug }}/favorite" id="favoriteToggle" class=" js-font-resize d-flex flex-column align-items-center text-gray">
                        ...
                        <div class=" js-font-resize mt-30 text-center">
                            <button type="button" id="webinarReportBtn" class=" js-font-resize font-14 text-gray btn-transparent">{{ trans('update.report_this_course') }}</button>
                        </div>
                    </div>
                </div>
                ...
                @if($upcomingCourse->teacher->offline)
                    <div class=" js-font-resize rounded-lg shadow-sm mt-35 d-flex">
                        ...
                        <div class=" js-font-resize p-15">
                            ...
                            <p class=" js-font-resize font-14 font-weight-500 text-gray mt-15">{{ $upcomingCourse->teacher->offline_message }}</p>
                        </div>
                    </div>
                @endif

                <div class=" js-font-resize rounded-lg shadow-sm mt-35 px-25 py-20">
                    <h3 class=" js-font-resize sidebar-title font-16 text-secondary font-weight-bold">{{ trans('update.course_specifications') }}</h3>
                    ...
                    <div class=" js-font-resize mt-30">
                        @if(!empty($upcomingCourse->publish_date))
                            <div class=" js-font-resize mt-20 d-flex align-items-center justify-content-between text-gray">
                                <div class=" js-font-resize d-flex align-items-center">
                                    <i data-feather="calendar" width="20" height="20"></i>
                                    <span class=" js-font-resize ml-5 font-14 font-weight-500">{{ trans('update.publish_date') }}:</span>
                                </div>
                                <span class=" js-font-resize font-14">{{ dateTimeFormat($upcomingCourse->publish_date, 'j M Y | H:i') }}</span>
                            </div>
                        @endif
                        ...
                        @if(!empty($upcomingCourse->duration))
                            <div class=" js-font-resize mt-20 d-flex align-items-center justify-content-between text-gray">
                                ...
                                <span class=" js-font-resize font-14">{{ convertMinutesToHourAndMinute($upcomingCourse->duration) }} {{ trans('home.hours') }}</span>
                            </div>
                        @endif
                        ...
                        @if(!empty($upcomingCourse->sections))
                            <div class=" js-font-resize mt-20 d-flex align-items-center justify-content-between text-gray">
                                <div class=" js-font-resize d-flex align-items-center">
                                    ...
                                    <span class=" js-font-resize ml-5 font-14 font-weight-500">{{ trans('update.sections') }}:</span>
                                </div>
                                <span class=" js-font-resize font-14">{{ $upcomingCourse->sections }}</span>
                            </div>
                        @endif
                        ...
                        @if(!empty($upcomingCourse->parts))
                            <div class=" js-font-resize mt-20 d-flex align-items-center justify-content-between text-gray">
                                <div class=" js-font-resize d-flex align-items-center">
                                    ...
                                    <span class=" js-font-resize ml-5 font-14 font-weight-500">{{ trans('public.parts') }}:</span>
                                </div>
                                <span class=" js-font-resize font-14">{{ $upcomingCourse->parts }}</span>
                            </div>
                        @endif
                        ...
                        @if(!empty($upcomingCourse->capacity))
                            <div class=" js-font-resize mt-20 d-flex align-items-center justify-content-between text-gray">
                                ...
                                <span class=" js-font-resize font-14">{{ $upcomingCourse->capacity }}</span>
                            </div>
                        @endif
                        ...
                        <div class=" js-font-resize mt-20 d-flex align-items-center justify-content-between text-gray">
                            <div class=" js-font-resize d-flex align-items-center">
                                ...
                                <span class=" js-font-resize ml-5 font-14 font-weight-500">{{ trans('public.price') }}:</span>
                            </div>
                            <span class=" js-font-resize font-14">{{ (!empty($upcomingCourse->price) and $upcomingCourse->price > 0) ? handlePrice($upcomingCourse->price) : trans('public.free') }}</span>
                        </div>
                        ...
                        @if(!empty($upcomingCourse->course_progress))
                            <div class=" js-font-resize mt-20 d-flex align-items-center justify-content-between text-gray">
                                <div class=" js-font-resize d-flex align-items-center">
                                    ...
                                    <span class=" js-font-resize ml-5 font-14 font-weight-500">{{ trans('update.progress') }}:</span>
                                </div>
                                <span class=" js-font-resize font-14">{{ $upcomingCourse->course_progress }}%</span>
                            </div>

                            <div class=" js-font-resize progress upcoming-course-progress mt-15">
                                <span class=" js-font-resize progress-bar {{ ($upcomingCourse->course_progress < 50) ? 'less-50' : '' }}" style="width: {{ $upcomingCourse->course_progress }}%"></span>
                            </div>
                        @endif
    ...
    <div id="webinarReportModal" class=" js-font-resize d-none">
        ...
        <form action="/upcoming_courses/{{ $upcomingCourse->id }}/report" method="post" class=" js-font-resize mt-25">
            ...
            <div class=" js-font-resize mt-30 d-flex align-items-center justify-content-end">
                <button type="button" class=" js-font-resize js-course-report-submit btn btn-sm btn-primary">{{ trans('panel.report') }}</button>
