<div class=" js-font-resize d-none" id="blogShareModal">
    ...
    <div class=" js-font-resize text-center">
        ...
        <p class=" js-font-resize mt-20 font-14">{{ trans('update.share_this_post_with_others') }}</p>
        ...
        <div class=" js-font-resize position-relative d-flex align-items-center justify-content-between p-15 mt-15 border border-gray250 rounded-sm mt-5">
            <div class=" js-font-resize js-blog-share-link font-weight-bold px-16 text-ellipsis font-14">{{ url($post->getUrl()) }}</div>

            <button type="button" class=" js-font-resize js-blog-share-link-copy btn btn-primary btn-sm font-14 font-weight-500 flex-none" data-toggle="tooltip" data-placement="top" title="{{ trans('public.copy') }}">{{ trans('public.copy') }}</button>
        </div>

        <div class=" js-font-resize mt-32 mt-lg-40 row align-items-center font-14">
            <a href="{{ $post->getShareLink('telegram') }}" target="_blank" class=" js-font-resize col text-center">
            ...
            <a href="{{ $post->getShareLink('whatsapp') }}" target="_blank" class=" js-font-resize col text-center">
            ...
            <a href="{{ $post->getShareLink('facebook') }}" target="_blank" class=" js-font-resize col text-center">
            ...
            <a href="{{ $post->getShareLink('twitter') }}" target="_blank" class=" js-font-resize col text-center">
