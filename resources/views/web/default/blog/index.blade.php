...
@section('content')
    <section class=" js-font-resize site-top-banner search-top-banner opacity-04 position-relative">
        <img src="{{ getPageBackgroundSettings('blog') }}" class=" js-font-resize img-cover" alt=""/>
            ...
            <div class=" js-font-resize row h-100 align-items-center justify-content-center text-center">
                <div class=" js-font-resize col-12 col-md-9 col-lg-7">
                    <div class=" js-font-resize top-search-categories-form">
                        ...
                        <span class=" js-font-resize course-count-badge py-5 px-10 text-white rounded">{{ $blogCount }} {{ trans('site.posts') }}</span>
                        ...
                        <div class=" js-font-resize search-input bg-white p-10 flex-grow-1">
                            <form action="/blog" method="get">
                                <div class=" js-font-resize form-group d-flex align-items-center m-0">
                                    <input type="text" name="search" class=" js-font-resize form-control border-0" value="{{ request()->get('search') }}" placeholder="{{ trans('home.blog_search_placeholder') }}"/>
    ...
    <section class=" js-font-resize container mt-10 mt-md-40">
        <div class=" js-font-resize row">
            <div class=" js-font-resize col-12 col-lg-8">
                <div class=" js-font-resize row">
                    @foreach($blog as $post)
                        <div class=" js-font-resize col-12 col-md-4 col-lg-6">
            ...
            <div class=" js-font-resize col-12 col-lg-4">
                ...
                <div class=" js-font-resize p-20 mt-30 rounded-sm shadow-lg border border-gray300">
                    <h3 class=" js-font-resize category-filter-title font-20 font-weight-bold text-dark-blue">{{ trans('site.popular_posts') }}</h3>
                            ...
                            <div class=" js-font-resize popular-post d-flex align-items-start mt-20">
                                ...
                                <div class=" js-font-resize popular-post-content d-flex flex-column ml-10">
                                    <a href="{{ $popularPost->getUrl() }}">
                                        <h3 class=" js-font-resize text-dark-blue font-14">{{ truncate($popularPost->title,50) }}</h3>
                                    </a>
        ...
        <div class=" js-font-resize mt-20 mt-md-50 pt-30">
