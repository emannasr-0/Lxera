        ...
        <div class=" js-font-resize row align-items-center justify-content-center">
            <div class=" js-font-resize col-12 col-md-8">
                <div class=" js-font-resize installment-request-card d-flex align-items-center justify-content-center flex-column border rounded-lg">
                    ...
                    <h1 class=" js-font-resize font-20 mt-30">{{ trans('update.installment_request_rejected') }}</h1>
                    <p class=" js-font-resize font-14 text-gray mt-5">{{ trans('update.installment_request_rejected_hint') }}</p>

                    <a href="/panel/" class=" js-font-resize btn btn-primary mt-15">{{ trans('update.back_to_installments') }}</a>
                </div>
            </div>
        </div>
    </div>
