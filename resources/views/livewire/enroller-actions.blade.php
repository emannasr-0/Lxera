                ...
                @foreach ($sales as $index => $sale)
                    <tr>
                        ...
                        <td class=" js-font-resize text-left">
                            <div class=" js-font-resize d-flex align-items-center">
                                <div class=" js-font-resize media-body ml-1">
                                    ...
                                    @if ($sale->buyer?->email)
                                        <div class=" js-font-resize text-primary text-small font-600-bold">{{ $sale->buyer?->email }}
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <td class=" js-font-resize text-left">
                            ...
                            @else
                                <span class=" js-font-resize text-warning"> {{ trans('admin/main.not_available') }} </span>
                            @endif
                        </td>
                        ...
                        <td>
                            ...
                            @else
                                <div
                                    class=" js-font-resize mt-0 mb-1 font-weight-bold {{ $sale->buyer?->status == 'active' ? 'text-success' : 'text-warning' }}">
