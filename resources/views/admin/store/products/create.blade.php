                ...
                <div class=" js-font-resize col-12 ">
                    <div class=" js-font-resize card">
                        <div class=" js-font-resize card-body">
                            @if ($errors->any())
                                <div class=" js-font-resize text-danger">{{ trans('update.please_fix_the_error_fields_that_are_specified') }}</div>
                            @endif

                            <form id="productForm" method="post" action="{{ getAdminPanelUrl() }}/store/products/{{ !empty($product) ? $product->id.'/update' : 'store' }}" class=" js-font-resize webinar-form">
                                {{ csrf_field() }}
                                        ...
                                        <div class=" js-font-resize row">
                                            <div class=" js-font-resize col-12">
                                                <div class=" js-font-resize form-group mt-15">
                                                    <textarea name="message_for_reviewer" rows="10" class=" js-font-resize form-control">{{ (!empty($product) and $product->message_for_reviewer) ? $product->message_for_reviewer : old('message_for_reviewer') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                                ...
                                <div class=" js-font-resize row">
                                    <div class=" js-font-resize col-12">
                                        ...
                                        <button type="button" id="saveAndPublish" class=" js-font-resize btn btn-success">{{ !empty($product) ? trans('admin/main.save_and_publish') : trans('admin/main.save_and_continue') }}</button>
