                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        ...
                        <div class="card-body">
                            ...
                            <span
                                class="d-block font-12 text-muted mt-1">{{ handlePrice($openInstallments['amount']) }}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        ...
                        <div class="card-body">
                            ...
                            <span
                                class="d-block font-12 text-muted mt-1">{{ handlePrice($finishedInstallments['amount']) }}</span>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    @foreach ($installment->steps as $step)
                                        ...
                                        <tr>
                                            <td class="text-left">
                                                ...
                                                {{-- <span class="d-block font-12 text-gray">{{ $step->deadline }}أيام بعد بدايه
                                                    الدورة</span> --}}
                                            </td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @else
                                                    <span
                                                        class="{{ $isOverdue ? 'text-danger' : 'text-dark-blue' }}">{{ trans('update.unpaid') }}
                                    ...
                                    <table class="table table-striped font-14">
                                        ...
                                        @foreach ($attachments as $attachment)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="{{ getAdminPanelUrl("/financial/installments/orders/{$order->id}/attachments/{$attachment->id}/download") }}"
        ...
        <div class="d-flex align-items-center justify-content-end my-3">
            ...
            @if ($order->status == 'pending_verification')
                @include('admin.includes.delete_button', [
                    ...
                    'btnText' =>
                        '<i class="fa fa-check"></i><span class="ml-2">' . trans('admin/main.approve') . '</span>',
            ...
            @if ($order->status == 'open')
                @include('admin.includes.delete_button', [
                    ...
                    'btnText' =>
                        '<i class="fa fa-check"></i><span class="ml-2">' . trans('admin/main.reject') . '</span>',
                    'noBtnTransparent' => true,
                ])
            @endif
        </div>
