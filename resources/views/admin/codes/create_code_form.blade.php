    <form action="{{ getAdminPanelUrl() }}/codes/store" method="POST">
    @csrf
    <section>
        <div class="row">
            <div class="col-12 col-md-4">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="">
                        <h2 class="section-title">{{ !empty($code) ? (trans('public.edit').' ('. $code->student_code .')') : trans('code.new_code') }}</h2>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="student_code" value=""  class="js-ajax-student_code form-control " placeholder=""/>
                     <p class="font-12 text-gray mt-1">يجب أن يبدأ ب SD</p>
