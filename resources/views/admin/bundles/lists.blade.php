                ...
                <div class="card-body">
                    <form method="get" class="mb-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="input-label">الدفعة</label>
                        ...
                        <div class="card-header">
                            @can('admin_webinars_export_excel')
                                <div class="text-right">
                                    <a href="{{ getAdminPanelUrl() }}/bundles/excel?{{ http_build_query(request()->all()) }}"
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td class="font-12">
                                                @if (empty($bundle->hasGroup))
                                                    <p class="badge badge-primary text-dark-blue">دفعات</p>
                                                @else
                                                    <p class="badge badge-danger text-light">مجموعات</p>
                                                @endif

                                            </td>

                                            <td class="font-12">{{ dateTimeFormat($bundle->start_date, 'Y M j | H:i') }}
                                            </td>

                                            <td class="font-12">{{ dateTimeFormat($bundle->end_date, 'Y M j | H:i') }}
                                            </td>
                                            ...
                                            <td width="150">
                                                <div class="btn-group dropdown table-actions">
                                                    <button type="button" class="btn-transparent dropdown-toggle text-light"
                                                    ...
                                                    <div class="dropdown-menu text-left webinars-lists-dropdown">
                                                        ...
                                                        @can('admin_webinar_students_lists')
                                                            <a href="{{ getAdminPanelUrl() }}/bundles/{{ $bundle->id }}/students"
                                                                target="_blank"
                                                                class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 "
                                                        ...
                                                        @if (!empty($bundle->hasGroup))
                                                            @can('admin_webinar_students_lists')
                                                                <a href="{{ getAdminPanelUrl() }}/bundles/{{ $bundle->id }}/groups"
                                                                    target="_blank"
                                                                    class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 "
                                                                    title="{{ trans('admin/main.groups') }}">
                                                                    <i class="fa fa-users"></i>
                                                                    <span
                                                                        class="ml-2">{{ trans('admin/main.groups') }}</span>
                                                                </a>
                                                            @endcan
                                                        @endif

                                                        @can('admin_support_send')
                                                            <a href="{{ getAdminPanelUrl() }}/supports/create?user_id={{ $bundle->teacher->id }}"
                                                                target="_blank"
                                                                class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1"
                                                        ...
                                                        @can('admin_bundles_edit')
                                                            <a href="{{ getAdminPanelUrl() }}/bundles/{{ $bundle->id }}/edit?type={{ $bundle->type }}"
                                                                target="_blank"
                                                                class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 "
