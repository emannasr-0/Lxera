                ...
                <table class="table table-striped font-14">
                    ...
                    @foreach ($bundlstudents as $index => $bundlstudent)
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="d-flex align-items-center">
                                    <figure class="avatar mr-2">
                                        <img src="{{$bundlstudent->student->registeredUser->getAvatar() }}"
                                            alt="{{ $bundlstudent->student? $bundlstudent->student->ar_name : null }}">
                                    </figure>
                            ...
                            {{-- @php
                                $userBundles = $bundlstudent->student->bundleStudent()->whereNull('class_id')->get();
                            @endphp --}}
                            {{-- <td>
                            ...
                            <td class="text-center mb-2" width="120">
                                ...
                                {{-- @can('admin_users_delete')
                                    @include('admin.includes.delete_button', [
                                        'url' => getAdminPanelUrl() . '/users/' . $bundlstudent->student->registeredUser->id . '/delete',
                                        'btnClass' => '',
