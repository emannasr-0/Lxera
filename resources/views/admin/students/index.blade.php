                    ...
                    <div class=" js-font-resize row">
                        ...
                        <div class=" js-font-resize col-md-3">
                            <div class=" js-font-resize form-group">
                                ...
                                <input name={{ 'user_name' }} type="text" class=" js-font-resize form-control"
            ...
            <div class=" js-font-resize row">
                ...
                @if ($lastSegment === 'users')
                    <div class=" js-font-resize col-6">
                        <div class=" js-font-resize media-body">
                            <div class=" js-font-resize text-primary mt-25 mb-1 font-weight-bold">
                                رفع الطلاب من اكسيل
                            </div>
                            <div class=" js-font-resize text-small font-600-bold">
