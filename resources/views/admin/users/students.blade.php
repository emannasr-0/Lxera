                    ...
                    <div class=" js-font-resize row">
                        ...
                        <div class=" js-font-resize col-md-3">
                            <div class=" js-font-resize form-group">
                                ...
                                <input name="full_name" type="text" class=" js-font-resize form-control"
                        ...
                        <div class=" js-font-resize col-md-3">
                            <div class=" js-font-resize form-group">
                                <label class=" js-font-resize input-label">البرنامج المسجل بيه</label>
                                <input name="program" type="text" class=" js-font-resize form-control"
        ...
        <div class=" js-font-resize card-header">
            ...
            @can('admin_users_send_password_mail')
                @include('admin.students.includes.importStudents', [
                    ...
                    'btnText' => '<span class=" js-font-resize ml-2">رفع الايميلات من الاكسيل</span>',
            ...
            <div class=" js-font-resize table-responsive text-center">
                <table class=" js-font-resize table table-striped font-14">
                    <tr>
                        ...
                        <th class=" js-font-resize text-left">الهوية الوطنية</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class=" js-font-resize media-body">
                                    ...
                                    <div class=" js-font-resize text-small font-600-bold">{{ handlePrice($user->classesPurchasedsSum) }}
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class=" js-font-resize media-body">
                                    ...
                                    <div class=" js-font-resize text-small font-600-bold">{{ handlePrice($user->meetingsPurchasedsSum) }}
                                    </div>
                                </div>
                            </td>
            ...
            if (selectInput.value && hiddenInput) {
                ...
                if (categoryBundles) {
                    ...
                    hiddenInput.outerHTML =
                        '<select id="bundle_id" name="toDiploma"  class=" js-font-resize form-control" onchange="CertificateSectionToggle(event)" required>' +
                        '<option value="" class=" js-font-resize placeholder" disabled="" selected="selected">اختر التخصص الذي تود دراسته في اكاديما</option>' +
                        options +
                        '</select>';
                }
            }
