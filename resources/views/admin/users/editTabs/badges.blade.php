<div class=" js-font-resize tab-pane mt-3 fade" id="badges" role="tabpanel" aria-labelledby="badges-tab">
        ...
        <div class=" js-font-resize col-12 col-md-6">
            <form action="{{ getAdminPanelUrl() }}/users/{{ $user->id .'/badgesUpdate' }}" method="Post">
                ...
                <div class=" js-font-resize form-group">
                    <select name="badge_id" class=" js-font-resize form-control @error('badge_id') is-invalid @enderror">
                        ...
                        @if(!empty($user->customBadges))
                            @foreach($user->customBadges as $customBadge)
                                ...
                                <tr>
                                    ...
                                    <td class=" js-font-resize text-center">{{ dateTimeFormat($customBadge->badge->created_at,'j M Y') }}</td>
                                    <td>
