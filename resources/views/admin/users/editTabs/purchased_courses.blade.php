<div class=" js-font-resize tab-pane mt-3 fade" id="purchased_courses" role="tabpanel" aria-labelledby="purchased_courses-tab">
    <div class=" js-font-resize row">

        @can('admin_enrollment_add_student_to_items')
            <div class=" js-font-resize col-12 col-md-6">
                <h5 class=" js-font-resize section-title after-line">{{ trans('update.add_student_to_course') }}</h5>
                ...
                <form action="{{ getAdminPanelUrl() }}/enrollments/store" method="Post">
                    ...
                    <div class=" js-font-resize form-group">
                        ...
                        <select name="webinar_id" class=" js-font-resize form-control search-webinar-select2"
        ...
        <div class=" js-font-resize col-12">
            <div class=" js-font-resize mt-5">
                <h5 class=" js-font-resize section-title after-line">{{ trans('update.manual_added') }}</h5>
                    ...
                    <table class=" js-font-resize table table-striped table-md">
                        ...
                        @if(!empty($manualAddedClasses))
                            @foreach($manualAddedClasses as $manualAddedClass)
                                ...
                                <tr>
                                    <td width="25%">
                                        <a href="{{ !empty($manualAddedClass->webinar) ? $manualAddedClass->webinar->getUrl() : '#1' }}" target="_blank" class=" js-font-resize ">{{ !empty($manualAddedClass->webinar) ? $manualAddedClass->webinar->title : trans('update.deleted_item') }}</a>
                                    </td>
                                    ...
                                    <td class=" js-font-resize text-center">{{ dateTimeFormat($manualAddedClass->created_at,'j M Y | H:i') }}</td>
        ...
        <div class=" js-font-resize col-12">
            <div class=" js-font-resize mt-5">
                <h5 class=" js-font-resize section-title after-line">{{ trans('update.manual_disabled') }}</h5>
                    ...
                    <table class=" js-font-resize table table-striped table-md">
                        ...
                        @if(!empty($manualDisabledClasses))
                            @foreach($manualDisabledClasses as $manualDisabledClass)
                                ...
                                <tr>
                                    <td width="25%">
                                        <a href="{{ !empty($manualDisabledClass->webinar) ? $manualDisabledClass->webinar->getUrl() : '#1' }}" target="_blank" class=" js-font-resize ">{{ !empty($manualDisabledClass->webinar) ? $manualDisabledClass->webinar->title : trans('update.deleted_item') }}</a>
                                    </td>
                    ...
                    <table class=" js-font-resize table table-striped table-md">
                        ...
                        @if(!empty($purchasedClasses))
                            @foreach($purchasedClasses as $purchasedClass)
                                ...
                                <tr>
                                    <td width="25%">
                                        <a href="{{ !empty($purchasedClass->webinar) ? $purchasedClass->webinar->getUrl() : '#1' }}" target="_blank" class=" js-font-resize ">{{ !empty($purchasedClass->webinar) ? $purchasedClass->webinar->title : trans('update.deleted_item') }}</a>
                                    </td>
                                    ...
                                    <td class=" js-font-resize text-center">{{ dateTimeFormat($purchasedClass->created_at,'j M Y | H:i') }}</td>
