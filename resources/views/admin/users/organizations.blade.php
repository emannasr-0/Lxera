    ...
    <section class=" js-font-resize section">
        <div class=" js-font-resize section-header">
            ...
            <div class=" js-font-resize section-header-breadcrumb">
                <div class=" js-font-resize breadcrumb-item active"><a href="#">{{ trans('admin/main.organizations_list') }}</a></div>
            ...
            <div class=" js-font-resize col-lg-3 col-md-6 col-sm-6 col-12">
                <div class=" js-font-resize card card-statistic-1">
                    <div class=" js-font-resize card-icon bg-primary">
                        <i class=" js-font-resize fas fa-building"></i>
                    </div>
            ...
            <div class=" js-font-resize col-lg-3 col-md-6 col-sm-6 col-12">
                <div class=" js-font-resize card card-statistic-1">
                    <div class=" js-font-resize card-icon bg-success">
                        <i class=" js-font-resize fas fa-check-circle"></i></div>
                    <div class=" js-font-resize card-wrap">
                        <div class=" js-font-resize card-header">
            ...
            <div class=" js-font-resize col-lg-3 col-md-6 col-sm-6 col-12">
                <div class=" js-font-resize card card-statistic-1">
                    <div class=" js-font-resize card-icon bg-warning">
                        <i class=" js-font-resize fas fa-address-card"></i></div>
                    <div class=" js-font-resize card-wrap">
                        <div class=" js-font-resize card-header">
            ...
            <div class=" js-font-resize col-lg-3 col-md-6 col-sm-6 col-12">
                <div class=" js-font-resize card card-statistic-1">
                    <div class=" js-font-resize card-icon bg-info">
                        <i class=" js-font-resize fas fa-graduation-cap"></i></div>
                    <div class=" js-font-resize card-wrap">
                        <div class=" js-font-resize card-header">
    ...
    <div class=" js-font-resize card">
        <div class=" js-font-resize card-header">
            @can('admin_users_export_excel')
                <a href="{{ getAdminPanelUrl() }}/organizations/excel?{{ http_build_query(request()->all()) }}" class=" js-font-resize btn btn-primary">{{ trans('admin/main.export_xls') }}</a>
            @endcan
                ...
                <table class=" js-font-resize table table-striped font-14">
                    ...
                    @foreach($users as $user)
                        ...
                        <tr>
                            ...
                            <td class=" js-font-resize text-primary mt-0 mb-1 font-weight-bold">{{ $user->getOrganizationTeachers()->count() }}</td>
                            <td class=" js-font-resize text-primary mt-0 mb-1 font-weight-bold">{{ $user->getOrganizationStudents()->count() }}</td>
                            ...
                            <td>
                                <div class=" js-font-resize media-body">
                                    @if($user->ban and !empty($user->ban_end_at) and $user->ban_end_at > time())
                                        ...
                                        <div class=" js-font-resize text-small font-600-bold">Until {{ dateTimeFormat($user->ban_end_at, 'j M Y') }}</div>
                                    @else
    ...
    <section class=" js-font-resize card">
        <div class=" js-font-resize card-body">
            ...
            <div class=" js-font-resize row">
                <div class=" js-font-resize col-md-4">
                    <div class=" js-font-resize media-body">
                        <div class=" js-font-resize text-primary mt-0 mb-1 font-weight-bold">{{trans('admin/main.organizations_hint_title_1')}}</div>
                        <div class=" js-font-resize  text-small font-600-bold">{{trans('admin/main.organizations_hint_description_1')}}</div>
                    </div>
                </div>

                <div class=" js-font-resize col-md-4">
                    <div class=" js-font-resize media-body">
                        <div class=" js-font-resize text-primary mt-0 mb-1 font-weight-bold">{{trans('admin/main.organizations_hint_title_2')}}</div>
                        <div class=" js-font-resize  text-small font-600-bold">{{trans('admin/main.organizations_hint_description_2')}}</div>
                    </div>
                </div>
                ...
                <div class=" js-font-resize col-md-4">
                    <div class=" js-font-resize media-body">
                        <div class=" js-font-resize text-primary mt-0 mb-1 font-weight-bold">{{trans('admin/main.organizations_hint_title_3')}}</div>
                        <div class=" js-font-resize text-small font-600-bold">{{trans('admin/main.organizations_hint_description_3')}}</div>
                    </div>
                </div>
