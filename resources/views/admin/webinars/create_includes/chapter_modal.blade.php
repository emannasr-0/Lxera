    ...
    <div class="custom-modal-body">
        ...
        <div class="js-content-form chapter-form mt-20" data-action="{{ getAdminPanelUrl() }}/chapters/store">
            ...
            <div class="form-group mt-2 d-flex align-items-center justify-content-between js-switch-parent">
                <label class="js-switch cursor-pointer text-dark" for="chapterStatus_record">{{ trans('public.active') }}</label>
            ...
            @if(getFeaturesSettings('sequence_content_status'))
                <div class="form-group mt-2 d-flex align-items-center justify-content-between js-switch-parent">
                    <label class="js-switch cursor-pointer text-dark" for="checkAllContentsPassSwitch_record">{{ trans('update.check_all_contents_pass') }}</label>
