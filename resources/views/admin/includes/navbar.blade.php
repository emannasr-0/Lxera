...
<nav class="navbar navbar-expand-lg main-navbar justify-content-between js-font-resize">
    ...
    {{-- <li class="dropdown dropdown-list-toggle">
        ...
        @can('admin_notifications_list')
            <li class="dropdown dropdown-list-toggle js-font-resize">
                ...
                <div class="dropdown-menu dropdown-list dropdown-menu-right js-font-resize">
                    <div class="dropdown-header js-font-resize">{{ trans('admin/main.notifications') }}
                    ...
                    <div class="dropdown-list-content dropdown-list-icons">
                        @foreach($unreadNotifications as $unreadNotification)
                            <a href="{{ getAdminPanelUrl() }}/notifications" class="dropdown-item">
                                ...
                                <div class="dropdown-item-desc js-font-resize">
                    ...
                    <div class="dropdown-footer text-center js-font-resize">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user js-font-resize">
                <img alt="image" src="{{ $authUser->getAvatar() }}" class="mr-1">
                <div class="d-sm-none d-lg-inline-block js-font-resize">{{ $authUser->full_name }}</div>
            </a>

            <div class="dropdown-menu dropdown-menu-right">

                <a href="/" class="dropdown-item has-icon js-font-resize">
                   <i class="fas fa-globe"></i> {{ trans('admin/main.show_website') }}
               </a>

               <a href="{{ getAdminPanelUrl() }}/users/{{ $authUser->id }}/edit" class="dropdown-item has-icon js-font-resize">
                   <i class="fas fa-cog"></i> {{ trans('admin/main.change_password') }}
               </a>

               <div class="dropdown-divider"></div>
               <a href="{{ getAdminPanelUrl() }}/logout" class="dropdown-item has-icon text-danger js-font-resize">
