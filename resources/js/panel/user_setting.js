        ...
        if (val !== '' && val !== null) {
            ...
            $.post('/panel/setting/metas/' + education_id + '/update', data, function (result) {
                if (result && result.code == 200) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        html: '<h3 class="font-20 text-center text-dark py-25">' + notAccessToLang + '</h3>',
                        showConfirmButton: false,
                        width: '25rem',
                    });
                ...
                Swal.fire({
                    icon: 'error',
                    html: '<h3 class="font-20 text-center text-dark py-25">' + saveErrorLang + '</h3>',
                    showConfirmButton: false,
                    width: '25rem',
                });
        ...
        if (specifications) {
            Object.entries(JSON.parse(specifications)).forEach(([index, item], key) => {
                ...
                html += '<div class="form-group">\n' +
                    '         <label class="font-weight-500 text-dark">' + item + '</label>\n' +
