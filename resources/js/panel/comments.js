(function ($) {
    ...
    $('body').on('click', '.js-reply-comment', function (e) {
        ...
        var html = '<div class="">\n' +
            ...
            '        <div class="rounded-sm p-15 border border-gray300 bg-info-dark mt-20 text-gray">' + comment + '</div>\n' +
    ...
    $('body').on('click', '.report-comment', function (e) {
        ...
        const html = '<div id="reportModal">\n' +
            '    <h3 class="section-title after-line font-20 text-dark mb-25">' + reportLang + '</h3>\n' +
            '\n' +
