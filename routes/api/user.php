...
Route::group([], function () {
    ...
    Route::get('learning-page/{id}', [WebinarsController::class, 'getWebinarsLessons']);
    Route::get('{bundle}/learning-page/{id}', [WebinarsController::class, 'getWebinarsLessons']);
    ...
    Route::get('/program/{bundleId}/showCertificate/{format?}', 'CertificatesController@makeBundleCertificate');
    ...
    Route::group(['prefix' => 'financial'], function () {
        ...
        Route::post('/charge', ['uses' => 'PaymentController@charge']);
        Route::post('/web_charge', ['uses' => 'PaymentController@webChargeGenerator']);
        ...
        Route::group(['prefix' => 'payout'], function () {
            ...
            Route::group(['prefix' => 'payments'], function () {
                Route::post('/request', 'PaymentController@paymentRequest');
                Route::post('/credit', 'PaymentController@paymentByCredit');
            ...
            Route::group(['prefix' => 'profile-setting'], function () {
                ...
                Route::put('/addtional_details', ['uses' => 'UsersController@updateAddtionalDetails']);
                Route::put('/basic_information', ['uses' => 'UsersController@updateUserBasicInformation']);
                Route::post('/personal_details', ['uses' => 'UsersController@updatePersonalDetails']);
            ...
            Route::get('programs/apply', 'ApplyController@index');
            Route::post('/programs/apply', 'ApplyController@checkout');
            ...
            Route::group(['prefix' => 'services'], function () {
                ...
                Route::post('/{service}/apply', 'ServiceController@sendRequest');
            });
