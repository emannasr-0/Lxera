...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web',  'admin_locale']], function () use ($prefix) {
    //users activity
    Route::view('users_activity', 'admin.users_activity.index');
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'users'], function () {
            ...
            Route::post('/searchByCode', 'UserController@searchByCode');
        ...
        Route::group(['prefix' => 'programs/statistics'], function () {
            ...
            Route::get('/students', 'BundleController@studentStatistics')->name('admin.students.statistics');
            Route::get('/students/register_user', 'UserController@RegisteredUsers2');
            Route::get('referred-by/{code}', 'BundleController@studentsReferredByCode')->name('admin.students.referredByCode');
            Route::get('/students/referred/export/{code}', 'BundleController@exportReferredStudents')
                ->name('admin.students.referred.export');
            Route::get('/students/statistics/export',  'BundleController@exportStudentStatistics')->name('admin.students.statistics.export');
            Route::get('/admin/bundles/statistics/export', 'BundleController@BundleStatisticsExportExcel')->name('admin.bundles.statistics.export');
            Route::get('/admin/bundles/{bundle}/export-usercodes', 'BundleController@exportBundleUserCodes')
                ->name('admin.bundles.export.usercodes');
        });
